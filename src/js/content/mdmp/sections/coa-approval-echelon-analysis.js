/** MDMP Step 6: COA Approval - Echelon Analysis (Purple theme) */
export const coaApprovalEchelonAnalysisModule = {
  id: 'coa-approval-echelon-analysis',
  title: 'Echelon Analysis',
  defaultExpanded: false,
  getContent() {
    return `
      <div id="coa-approval-echelon-analysis-section" style="margin-bottom:24px;">
        ...
        <div id="coa-approval-echelon-content" style="min-height:300px;">
  ...
  initializeDropdowns() {
    document.querySelectorAll('#coa-approval-echelon-analysis-section .echelon-dropdown').forEach(dropdown => {
  ...
  initializeButtons() {
    document.querySelectorAll('#coa-approval-echelon-analysis-section .example-tab-btn').forEach(btn => {
  ...
  injectDropdownCSS() {
    const style = document.getElementById('coa-approval-echelon-dropdown-styles') || document.createElement('style');
    style.id = 'coa-approval-echelon-dropdown-styles';
    style.textContent = `
      #coa-approval-echelon-analysis-section .echelon-dropdown-btn:hover { color:#10b981 !important; transition: color .3s ease !important; }
      #coa-approval-echelon-analysis-section .dropdown-item:hover { background-color:#374151 !important; transition: all .2s ease !important; }
      #coa-approval-echelon-analysis-section .dropdown-content { transition: opacity .2s ease !important; z-index:1000 !important; position:absolute !important; top:100% !important; left:0 !important; background-color:#1f2937 !important; border:1px solid #374151 !important; border-radius:6px !important; box-shadow:0 4px 12px rgba(0,0,0,.3) !important; min-width:200px !important; padding:8px !important; }
      #coa-approval-echelon-analysis-section .echelon-dropdown { position: relative !important; display: inline-block !important; }
      #coa-approval-echelon-analysis-section .echelon-dropdown:hover .dropdown-content { display: block !important; }
    `;
    const existing = document.getElementById('coa-approval-echelon-dropdown-styles');
  ...
  async loadEchelonAnalysis(echelon) {
    const contentArea = document.getElementById('coa-approval-echelon-content');
    ...
    catch (error) { console.error('Failed to load COA approval echelon analysis:', error); contentArea.innerHTML = '<div style="text-align:center; padding:40px; color:#ef4444;"><i class="fas fa-exclamation-triangle" style="font-size:24px; margin-bottom:12px;"></i><p>Failed to load content</p></div>'; }
  },
  async importEchelonAnalysis(tab) {
    switch (tab) {
      case 'platoon': { const m = await import('./coa-approval-analysis-platoon.js'); return m.platoonCOAApprovalModule.getContent(); }
      case 'company': { const m = await import('./coa-approval-analysis-company.js'); return m.companyCOAApprovalModule.getContent(); }
      case 'squadron': { const m = await import('./coa-approval-analysis-squadron.js'); return m.squadronCOAApprovalModule.getContent(); }
      case 'battalion': { const m = await import('./coa-approval-analysis-battalion.js'); return m.battalionCOAApprovalModule.getContent(); }
      case 'regiment': { const m = await import('./coa-approval-analysis-regiment.js'); return m.regimentCOAApprovalModule.getContent(); }
      case 'group': { const m = await import('./coa-approval-analysis-group.js'); return m.groupCOAApprovalModule.getContent(); }
      case 'brigade': { const m = await import('./coa-approval-analysis-brigade.js'); return m.brigadeCOAApprovalModule.getContent(); }
      case 'division': { const m = await import('./coa-approval-analysis-division.js'); return m.divisionCOAApprovalModule.getContent(); }
      case 'corps': { const m = await import('./coa-approval-analysis-corps.js'); return m.corpsCOAApprovalModule.getContent(); }
      case 'army': { const m = await import('./coa-approval-analysis-army.js'); return m.armyCOAApprovalModule.getContent(); }
      case 'theater': { const m = await import('./coa-approval-analysis-theater.js'); return m.theaterCOAApprovalModule.getContent(); }
  ...
  initialize() {
    ...
    this.documentClickHandler = (e) => {
      if (document.getElementById('coa-approval-echelon-content') && !e.target.closest('.echelon-dropdown') && !e.target.closest('#sidebar') && !e.target.closest('#right-sidebar')) { this.hideAll(); }
    };
...
export default coaApprovalEchelonAnalysisModule;
