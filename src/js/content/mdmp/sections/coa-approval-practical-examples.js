/** MDMP Step 6: COA Approval - Practical Examples (Green theme) */
export const coaApprovalPracticalExamplesModule = {
  id: 'coa-approval-practical-examples',
  title: 'Practical Examples',
  defaultExpanded: false,
  getContent() {
    return `
      <div id="coa-approval-practical-examples-section" style="margin-bottom:24px;">
        ...
        <div id="coa-approval-practical-content" style="min-height:300px;">
  ...
  initializeDropdowns() {
    document.querySelectorAll('#coa-approval-practical-examples-section .echelon-dropdown').forEach(dropdown => {
  ...
  initializeButtons() {
    document.querySelectorAll('#coa-approval-practical-examples-section .example-tab-btn').forEach(btn => {
  ...
  injectDropdownCSS() {
    const style = document.getElementById('coa-approval-practical-dropdown-styles') || document.createElement('style');
    style.id = 'coa-approval-practical-dropdown-styles';
    style.textContent = `
      #coa-approval-practical-examples-section .echelon-dropdown-btn:hover { color:#10b981 !important; transition: color .3s ease !important; }
      #coa-approval-practical-examples-section .dropdown-item:hover { background-color:#374151 !important; transition: all .2s ease !important; }
      #coa-approval-practical-examples-section .dropdown-content { transition: opacity .2s ease !important; z-index:1000 !important; position:absolute !important; top:100% !important; left:0 !important; background-color:#1f2937 !important; border:1px solid #374151 !important; border-radius:6px !important; box-shadow:0 4px 12px rgba(0,0,0,.3) !important; min-width:200px !important; padding:8px !important; }
      #coa-approval-practical-examples-section .echelon-dropdown { position: relative !important; display: inline-block !important; }
      #coa-approval-practical-examples-section .echelon-dropdown:hover .dropdown-content { display: block !important; }
    `;
    const existing = document.getElementById('coa-approval-practical-dropdown-styles');
  ...
  async loadEchelonExample(echelon) {
    const contentArea = document.getElementById('coa-approval-practical-content');
    ...
    catch (error) { console.error('Failed to load COA approval practical example:', error); contentArea.innerHTML = '<div style="text-align:center; padding:40px; color:#ef4444;"><i class="fas fa-exclamation-triangle" style="font-size:24px; margin-bottom:12px;"></i><p>Failed to load content</p></div>'; }
  },
  async importEchelon(tab) {
    switch (tab) {
      case 'platoon': { const m = await import('./coa-approval-practical-platoon.js'); return m.getPlatoonCOAApprovalExample(); }
      case 'company': { const m = await import('./coa-approval-practical-company.js'); return m.getCompanyCOAApprovalExample(); }
      case 'squadron': { const m = await import('./coa-approval-practical-squadron.js'); return m.getSquadronCOAApprovalExample(); }
      case 'battalion': { const m = await import('./coa-approval-practical-battalion.js'); return m.getBattalionCOAApprovalExample(); }
      case 'regiment': { const m = await import('./coa-approval-practical-regiment.js'); return m.getRegimentCOAApprovalExample(); }
      case 'group': { const m = await import('./coa-approval-practical-group.js'); return m.getGroupCOAApprovalExample(); }
      case 'brigade': { const m = await import('./coa-approval-practical-brigade.js'); return m.getBrigadeCOAApprovalExample(); }
      case 'division': { const m = await import('./coa-approval-practical-division.js'); return m.getDivisionCOAApprovalExample(); }
      case 'corps': { const m = await import('./coa-approval-practical-corps.js'); return m.getCorpsCOAApprovalExample(); }
      case 'army': { const m = await import('./coa-approval-practical-army.js'); return m.getArmyCOAApprovalExample(); }
      case 'theater': { const m = await import('./coa-approval-practical-theater.js'); return m.getTheaterCOAApprovalExample(); }
  ...
  initialize() {
    ...
    this.documentClickHandler = (e) => {
      if (document.getElementById('coa-approval-practical-content') && !e.target.closest('.echelon-dropdown') && !e.target.closest('#sidebar') && !e.target.closest('#right-sidebar')) { this.hideAll(); }
    };
...
export default coaApprovalPracticalExamplesModule;
