/**
 * OPORD Sustainment - Squadron Level Practical Examples
 * Aviation and cavalry squadron sustainment operations
 * Specialized sustainment requirements for mobile operations
 *
...
export const squadronPracticalModule = {
            ...
            <div id="squadron-practical-section" style="margin-bottom: 24px;">
                ...
                <div style="margin-bottom: 20px; padding-bottom: 12px; border-bottom: 2px solid #374151;">
                    <h3 style="font-size: 18px; font-weight: 600; color: white; margin: 0; display: flex; align-items: center;">
                        ...
                        4. Sustainment - Squadron Level Example
                    </h3>
                    <p style="color: #6ee7b7; font-size: 14px; margin: 8px 0 0 0;">
                        UNCLASSIFIED - 1st Squadron, 3rd Cavalry Regiment
                    </p>
                </div>
                ...
                <div style="background-color: #1e3a8a; padding: 16px; border-radius: 8px; border-left: 4px solid #3b82f6; margin-bottom: 24px;">
                    <h4 style="font-size: 16px; font-weight: 600; color: #dbeafe; margin: 0 0 8px 0;">
                        <i class="fas fa-horse-head" style="margin-right: 8px; color: #60a5fa;"></i>
                        Operation ALLIED RESOLVE - Squadron Sustainment Operations
                    </h4>
                    <p style="color: #bfdbfe; font-size: 13px; line-height: 1.4; margin: 0 0 12px 0;">
                        <strong>Command:</strong> 1st Squadron, 3rd Cavalry Regiment | <strong>Sector:</strong> Eastern AO | <strong>Forces:</strong> 600+ personnel
                    </p>
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-top: 12px;">
                        <div>
                            <h5 style="color: #93c5fd; font-size: 12px; font-weight: 600; margin: 0 0 6px 0;">Subordinate Troops</h5>
                            <ul style="color: #bfdbfe; font-size: 12px; line-height: 1.3; margin: 0; padding-left: 16px;">
                                <li>A Troop (Cavalry Troop)</li>
                                <li>B Troop (Cavalry Troop)</li>
                                <li>C Troop (Cavalry Troop)</li>
                                <li>HHT (Headquarters Troop)</li>
                            </ul>
                        </div>
                        <div>
                            <h5 style="color: #93c5fd; font-size: 12px; font-weight: 600; margin: 0 0 6px 0;">Squadron Sustainment Scope</h5>
                            <ul style="color: #bfdbfe; font-size: 12px; line-height: 1.3; margin: 0; padding-left: 16px;">
                                <li>Operational reach: 75km from brigade nodes</li>
                                <li>Distribution network: 4 troop nodes</li>
                                <li>Medical support: Level I cavalry operations</li>
                            </ul>
                        </div>
                    </div>
                </div>

                <!-- Squadron Sustainment Content Grid -->
                <div style="
                    display: grid;
                ...
                ">
                    ...
                    ">
                        ...
                        <p style="color: #d1d5db; font-size: 13px; line-height: 1.4; margin: 0 0 16px 0;">
                            Squadron-level integration with 1st ABCT and division assets, coordinating reconnaissance sustainment operations across four troops in eastern AO.
                        </p>
                        ...
                        <div style="background-color: rgba(30, 58, 138, 0.2); padding: 12px; border-radius: 6px; border: 1px solid #2563eb; margin-bottom: 16px;">
                            <h5 style="font-weight: 600; color: #93c5fd; font-size: 12px; margin: 0 0 8px 0;">Squadron Support Assets</h5>
                            <ul style="color: #d1d5db; font-size: 12px; line-height: 1.4; margin: 0; padding-left: 16px;">
                                <li><strong>S4:</strong> Squadron logistics officer</li>
                                <li><strong>SAS:</strong> Squadron aid station</li>
                                <li><strong>FARP:</strong> Forward arming and refueling point</li>
                                <li><strong>STCP:</strong> Squadron trains command post</li>
                            </ul>
                        </div>
                        ...
                        <div style="background-color: rgba(59, 130, 246, 0.15); padding: 12px; border-radius: 6px; border: 1px solid #3b82f6;">
                            ...
                            <ul style="color: #d1d5db; font-size: 12px; line-height: 1.4; margin: 0; padding-left: 16px;">
                                <li><strong>2nd Squadron:</strong> Adjacent cavalry boundary</li>
                                <li><strong>1-77 AR:</strong> Supported battalion</li>
                                <li><strong>1-1 FA:</strong> Field artillery support</li>
                            </ul>
                        </div>
                    </div>

                    <!-- Mobile Distribution Card -->
                    <div style="
                        background-color: #1f2937;
                        border: 1px solid #374151;
                        border-radius: 8px;
                    ...
                    ">
                        <h4 style="font-size: 14px; font-weight: 600; color: white; margin: 0 0 12px 0; display: flex; align-items: center;">
                            <i class="fas fa-truck-fast" style="margin-right: 8px; color: #16a34a; font-size: 12px;"></i>
                            b. Mobile Distribution
                        </h4>
                        <p style="color: #d1d5db; font-size: 13px; line-height: 1.4; margin: 0 0 16px 0;">
                            Squadron mobile distribution operations managing 4 troop nodes, coordinating 720 STONs daily throughput for cavalry reconnaissance operations.
                        </p>

                        <div style="background-color: rgba(22, 163, 74, 0.1); padding: 12px; border-radius: 6px; border: 1px solid #16a34a; margin-bottom: 16px;">
                            <h5 style="font-weight: 600; color: #86efac; font-size: 12px; margin: 0 0 8px 0;">Squadron Distribution Network</h5>
                            <ul style="color: #d1d5db; font-size: 12px; line-height: 1.4; margin: 0; padding-left: 16px;">
                                <li><strong>Squadron Hub:</strong> Squadron trains command post</li>
                                <li><strong>Troop Nodes:</strong> 4 troop trains</li>
                                <li><strong>FARP:</strong> Forward arming and refueling points</li>
                                <li><strong>Capacity:</strong> 720 STONs daily throughput</li>
                            </ul>
                        </div>

                        <div style="background-color: rgba(20, 83, 45, 0.2); padding: 12px; border-radius: 6px; border: 1px solid #16a34a; margin-bottom: 16px;">
                            <h5 style="font-weight: 600; color: #86efac; font-size: 12px; margin: 0 0 8px 0;">Mobile Transportation</h5>
                            <ul style="color: #d1d5db; font-size: 12px; line-height: 1.4; margin: 0; padding-left: 16px;">
                                <li><strong>Reconnaissance:</strong> M1127 Stryker RV</li>
                                <li><strong>Support:</strong> M1135 NBC RV</li>
                                <li><strong>Fuel Systems:</strong> M978 HEMTT tankers</li>
                        ...
                        <div style="background-color: rgba(34, 197, 94, 0.15); padding: 12px; border-radius: 6px; border: 1px solid #22c55e;">
                            ...
                            <ul style="color: #d1d5db; font-size: 12px; line-height: 1.4; margin: 0; padding-left: 16px;">
                                ...
                                <li><strong>Hand Receipts:</strong> Troop property accountability</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    ">
                        ...
                        <p style="color: #d1d5db; font-size: 13px; line-height: 1.4; margin: 0 0 16px 0;">
                            Squadron medical operations coordinating Level I medical support across four troops, managing 90+ medical personnel and squadron aid station.
                        </p>
                        ...
                        <div style="background-color: rgba(248, 113, 113, 0.1); padding: 12px; border-radius: 6px; border: 1px solid #f87171; margin-bottom: 16px;">
                            <h5 style="font-weight: 600; color: #fca5a5; font-size: 12px; margin: 0 0 8px 0;">Squadron Medical Command</h5>
                            <ul style="color: #d1d5db; font-size: 12px; line-height: 1.4; margin: 0; padding-left: 16px;">
                                <li><strong>Squadron Surgeon:</strong> Medical authority</li>
                                <li><strong>SAS:</strong> Squadron aid station</li>
                                <li><strong>68W:</strong> Combat medics (x18)</li>
                        ...
                        <div style="background-color: rgba(127, 29, 29, 0.2); padding: 12px; border-radius: 6px; border: 1px solid #dc2626; margin-bottom: 16px;">
                            ...
                            <ul style="color: #d1d5db; font-size: 12px; line-height: 1.4; margin: 0; padding-left: 16px;">
                                <li><strong>Level I:</strong> Squadron aid station</li>
                    ...
                    ">
                        ...
                        <p style="color: #d1d5db; font-size: 13px; line-height: 1.4; margin: 0 0 16px 0;">
                            Squadron-level sustainment planning coordinating four troop operations across 12-day campaign, integrating brigade requirements and troop support.
                        </p>
                        ...
                        <div style="background-color: rgba(147, 51, 234, 0.1); padding: 12px; border-radius: 6px; border: 1px solid #9333ea; margin-bottom: 16px;">
                            ...
                            <ul style="color: #d1d5db; font-size: 12px; line-height: 1.4; margin: 0; padding-left: 16px;">
                                <li><strong>Tactical (3-12 days):</strong> Squadron planning</li>
                                <li><strong>Immediate (0-3 days):</strong> Troop coordination</li>
                        ...
                        <div style="background-color: rgba(76, 29, 149, 0.2); padding: 12px; border-radius: 6px; border: 1px solid #7c3aed; margin-bottom: 16px;">
                            <h5 style="font-weight: 600; color: #c4b5fd; font-size: 12px; margin: 0 0 8px 0;">Troop Integration</h5>
                            <ul style="color: #d1d5db; font-size: 12px; line-height: 1.4; margin: 0; padding-left: 16px;">
                                <li><strong>A Troop:</strong> Cavalry operations</li>
                                <li><strong>B Troop:</strong> Cavalry operations</li>
                                <li><strong>C Troop:</strong> Cavalry operations</li>
                                <li><strong>HHT:</strong> Headquarters operations</li>
                            </ul>
                        </div>
                ...
                <div style="background-color: #1f2937; border: 1px solid #374151; border-radius: 8px; padding: 20px; margin-bottom: 24px;">
                    <h4 style="font-size: 16px; font-weight: 600; color: white; margin: 0 0 16px 0; display: flex; align-items: center;">
                        ...
                        1st Squadron, 3rd Cavalry Regiment Sustainment Structure
                    </h4>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                        <div>
                            <div style="background-color: #374151; padding: 12px; border-radius: 6px; border-left: 3px solid #ef4444; margin-bottom: 12px;">
                                ...
                                <ul style="color: #d1d5db; font-size: 12px; line-height: 1.3; margin: 0; padding-left: 16px;">
                                    <li>Squadron deployment: 600 personnel</li>
                                    <li>Equipment movement: 10.8K STONs</li>
                                    <li>Initial stocks: 3 DOS</li>
                                    <li>Reception operations: Troop level</li>
                                </ul>
                            </div>
                            <div style="background-color: #374151; padding: 12px; border-radius: 6px; border-left: 3px solid #f59e0b; margin-bottom: 12px;">
                                <h5 style="color: #fbbf24; font-size: 12px; font-weight: 600; margin: 0 0 6px 0;">Phase II: Employment (D+2 to D+4)</h5>
                                <ul style="color: #d1d5db; font-size: 12px; line-height: 1.3; margin: 0; padding-left: 16px;">
                                    <li>Troop deployment: 4 troops operational</li>
                                    <li>Distribution network: 4 nodes active</li>
                                    <li>Medical facilities: Level I</li>
                                    <li>Sustainment stocks: 5 DOS</li>
                                </ul>
                            </div>
                        </div>
                        <div>
                            <div style="background-color: #374151; padding: 12px; border-radius: 6px; border-left: 3px solid #10b981; margin-bottom: 12px;">
                                <h5 style="color: #6ee7b7; font-size: 12px; font-weight: 600; margin: 0 0 6px 0;">Phase III: Operations (D+5 to D+10)</h5>
                                <ul style="color: #d1d5db; font-size: 12px; line-height: 1.3; margin: 0; padding-left: 16px;">
                                    <li>Steady-state: 720 STONs/day</li>
                                    <li>Coalition integration: Limited</li>
                                    <li>Host nation support: Minimal</li>
                                    <li>Contractor support: 3%</li>
                                </ul>
                            </div>
                            <div style="background-color: #374151; padding: 12px; border-radius: 6px; border-left: 3px solid #3b82f6; margin-bottom: 12px;">
                                <h5 style="color: #93c5fd; font-size: 12px; font-weight: 600; margin: 0 0 6px 0;">Phase IV: Transition (D+11 to D+12)</h5>
                                <ul style="color: #d1d5db; font-size: 12px; line-height: 1.3; margin: 0; padding-left: 16px;">
                                    <li>Force adjustment: 8% reduction</li>
                                    <li>Equipment retrograde: 9.9K STONs</li>
                                    <li>Infrastructure handover: Brigade</li>
                                    <li>Lessons learned: Squadron level</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div style="background-color: #1f2937; border: 1px solid #374151; border-radius: 8px; padding: 20px; margin-bottom: 24px;">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr 1fr 1fr; gap: 12px; margin-bottom: 16px;">
                        ...
                        <div style="background-color: #374151; padding: 12px; border-radius: 6px; text-align: center;">
                            ...
                            <div style="color: #d1d5db; font-size: 12px;">Troop Commands</div>
                        </div>
                    </div>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                        <div style="background-color: rgba(6, 182, 212, 0.1); padding: 12px; border-radius: 6px; border: 1px solid #06b6d4;">
                            ...
                            <ul style="color: #d1d5db; font-size: 12px; line-height: 1.3; margin: 0; padding-left: 16px;">
                                <li>Supply availability: 93.6%</li>
                                <li>Distribution reliability: 90.2%</li>
                                <li>Transportation on-time: 87.4%</li>
                                <li>Inventory accuracy: 95.8%</li>
                            </ul>
                        </div>
                        <div style="background-color: rgba(16, 185, 129, 0.1); padding: 12px; border-radius: 6px; border: 1px solid #10b981;">
                            ...
                            <ul style="color: #d1d5db; font-size: 12px; line-height: 1.3; margin: 0; padding-left: 16px;">
                                <li>Survival rate: 93.4%</li>
                                <li>Golden hour compliance: 76.2%</li>
                                <li>CASEVAC response: 24.8 min avg</li>
                                <li>Treatment capacity: 82.7%</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                        ...
                        <div>
                            ...
                            <ul style="color: #bfdbfe; font-size: 12px; line-height: 1.3; margin: 0; padding-left: 16px;">
                                ...
                                <li>ATP 3-20.97: Cavalry Troop</li>
                ...
                <div style="margin-top: 16px; padding: 12px; background-color: #065f46; border-radius: 6px; border-left: 3px solid #10b981;">
                    <p style="color: #6ee7b7; font-size: 12px; margin: 0; text-align: center;">
                        ...
                        UNCLASSIFIED - Squadron Level Sustainment Operations per FM 5-0 and FM 4-0 Standards
                    </p>
                </div>
            </div>
        `;
    ...
    initialize: function() {
        console.log('DEBUG: Squadron Sustainment Practical Examples module initialized');
        return true;
    }
};
