/**
 * OPORD Sustainment - Regiment Level Practical Examples
 * Multi-battalion sustainment operations and coordination
 * Regimental-level logistics and support operations
 *
...
export const regimentPracticalModule = {
            ...
            <div id="regiment-practical-section" style="margin-bottom: 24px;">
                ...
                <div style="margin-bottom: 20px; padding-bottom: 12px; border-bottom: 2px solid #374151;">
                    <h3 style="font-size: 18px; font-weight: 600; color: white; margin: 0; display: flex; align-items: center;">
                        ...
                        4. Sustainment - Regiment Level Example
                    </h3>
                    <p style="color: #6ee7b7; font-size: 14px; margin: 8px 0 0 0;">
                        UNCLASSIFIED - 75th Ranger Regiment
                    </p>
                </div>
                ...
                <div style="background-color: #1e3a8a; padding: 16px; border-radius: 8px; border-left: 4px solid #3b82f6; margin-bottom: 24px;">
                    <h4 style="font-size: 16px; font-weight: 600; color: #dbeafe; margin: 0 0 8px 0;">
                        <i class="fas fa-bolt" style="margin-right: 8px; color: #60a5fa;"></i>
                        Operation ALLIED RESOLVE - Regiment Sustainment Operations
                    </h4>
                    <p style="color: #bfdbfe; font-size: 13px; line-height: 1.4; margin: 0 0 12px 0;">
                        <strong>Command:</strong> 75th Ranger Regiment | <strong>Sector:</strong> Western Europe | <strong>Forces:</strong> 3,800+ personnel
                    </p>
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-top: 12px;">
                        <div>
                            ...
                            <ul style="color: #bfdbfe; font-size: 12px; line-height: 1.3; margin: 0; padding-left: 16px;">
                                <li>1st Ranger Battalion (1/75)</li>
                                <li>2nd Ranger Battalion (2/75)</li>
                                <li>3rd Ranger Battalion (3/75)</li>
                                <li>75th Ranger Regiment Special Troops Battalion</li>
                            </ul>
                        </div>
                        <div>
                            <h5 style="color: #93c5fd; font-size: 12px; font-weight: 600; margin: 0 0 6px 0;">Regiment Sustainment Scope</h5>
                            <ul style="color: #bfdbfe; font-size: 12px; line-height: 1.3; margin: 0; padding-left: 16px;">
                                <li>Operational reach: 250km from division nodes</li>
                                <li>Distribution network: 7 specialized nodes</li>
                                <li>Medical support: Level I-II Ranger operations</li>
                            </ul>
                        </div>
                    </div>
                </div>

                <!-- Regiment Sustainment Content Grid -->
                <div style="
                    display: grid;
                ...
                ">
                    ...
                    ">
                        ...
                        <p style="color: #d1d5db; font-size: 13px; line-height: 1.4; margin: 0 0 16px 0;">
                            Regiment-level integration with 1st Armored Division and corps assets, coordinating combined arms sustainment operations across four battalions in western sector.
                        </p>
                        ...
                        <div style="background-color: rgba(30, 58, 138, 0.2); padding: 12px; border-radius: 6px; border: 1px solid #2563eb; margin-bottom: 16px;">
                            <h5 style="font-weight: 600; color: #93c5fd; font-size: 12px; margin: 0 0 8px 0;">Regiment Support Assets</h5>
                            <ul style="color: #d1d5db; font-size: 12px; line-height: 1.4; margin: 0; padding-left: 16px;">
                                <li><strong>RSB:</strong> Regimental support battalion</li>
                                <li><strong>RSMC:</strong> Regimental support medical company</li>
                                <li><strong>BSC:</strong> Battalion support companies (x4)</li>
                                <li><strong>RCTCP:</strong> Regimental combat trains command post</li>
                            </ul>
                        </div>
                        ...
                        <div style="background-color: rgba(59, 130, 246, 0.15); padding: 12px; border-radius: 6px; border: 1px solid #3b82f6;">
                            ...
                            <ul style="color: #d1d5db; font-size: 12px; line-height: 1.4; margin: 0; padding-left: 16px;">
                                <li><strong>1st ABCT:</strong> Adjacent brigade coordination</li>
                                <li><strong>2nd ABCT:</strong> Adjacent brigade coordination</li>
                                <li><strong>1st CAB:</strong> Aviation support coordination</li>
                            </ul>
                        </div>
                    </div>

                    <!-- Combined Arms Distribution Card -->
                    <div style="
                        background-color: #1f2937;
                        border: 1px solid #374151;
                        border-radius: 8px;
                    ...
                    ">
                        <h4 style="font-size: 14px; font-weight: 600; color: white; margin: 0 0 12px 0; display: flex; align-items: center;">
                            <i class="fas fa-truck-moving" style="margin-right: 8px; color: #16a34a; font-size: 12px;"></i>
                            b. Combined Arms Distribution
                        </h4>
                        <p style="color: #d1d5db; font-size: 13px; line-height: 1.4; margin: 0 0 16px 0;">
                            Regiment distribution network managing 7 nodes across western sector, coordinating 3,600 STONs daily throughput for combined arms operations.
                        </p>

                        <div style="background-color: rgba(22, 163, 74, 0.1); padding: 12px; border-radius: 6px; border: 1px solid #16a34a; margin-bottom: 16px;">
                            <h5 style="font-weight: 600; color: #86efac; font-size: 12px; margin: 0 0 8px 0;">Regiment Distribution Network</h5>
                            <ul style="color: #d1d5db; font-size: 12px; line-height: 1.4; margin: 0; padding-left: 16px;">
                                <li><strong>Regiment Hub:</strong> Hunter Army Airfield Support Area</li>
                                <li><strong>Battalion Nodes:</strong> 4 battalion support companies</li>
                                <li><strong>Company Nodes:</strong> Forward arming and refueling points</li>
                                <li><strong>Capacity:</strong> 3,600 STONs daily throughput</li>
                            </ul>
                        </div>
                        ...
                        <div style="background-color: rgba(20, 83, 45, 0.2); padding: 12px; border-radius: 6px; border: 1px solid #16a34a; margin-bottom: 16px;">
                            ...
                            <ul style="color: #d1d5db; font-size: 12px; line-height: 1.4; margin: 0; padding-left: 16px;">
                                <li><strong>Air Assets:</strong> MH-6M, MH-60M aircraft</li>
                                <li><strong>Ground Assets:</strong> MRAP, HMMWV variants</li>
                                <li><strong>Airborne:</strong> Parachute resupply systems</li>
                                <li><strong>Fast Rope:</strong> Helicopter insertion/extraction</li>
                            </ul>
                        </div>
                        ...
                        <div style="background-color: rgba(34, 197, 94, 0.15); padding: 12px; border-radius: 6px; border: 1px solid #22c55e;">
                            ...
                            <ul style="color: #d1d5db; font-size: 12px; line-height: 1.4; margin: 0; padding-left: 16px;">
                                <li><strong>GCSS-Army:</strong> Regiment logistics system</li>
                    ...
                    ">
                        ...
                        <p style="color: #d1d5db; font-size: 13px; line-height: 1.4; margin: 0 0 16px 0;">
                            Regiment medical operations coordinating Level I-II medical support across four battalions, managing 570+ medical personnel and specialized Ranger medical capabilities.
                        </p>
                        ...
                        <div style="background-color: rgba(248, 113, 113, 0.1); padding: 12px; border-radius: 6px; border: 1px solid #f87171; margin-bottom: 16px;">
                            <h5 style="font-weight: 600; color: #fca5a5; font-size: 12px; margin: 0 0 8px 0;">Regiment Medical Command</h5>
                            <ul style="color: #d1d5db; font-size: 12px; line-height: 1.4; margin: 0; padding-left: 16px;">
                                <li><strong>75th RGR Surgeon:</strong> Regimental medical authority</li>
                                <li><strong>RSMC:</strong> Regimental support medical company</li>
                                <li><strong>68W:</strong> Combat medics (enhanced training)</li>
                                <li><strong>SOMT:</strong> Special operations medical teams</li>
                            </ul>
                        </div>
                        ...
                        <div style="background-color: rgba(127, 29, 29, 0.2); padding: 12px; border-radius: 6px; border: 1px solid #dc2626; margin-bottom: 16px;">
                            ...
                            <ul style="color: #d1d5db; font-size: 12px; line-height: 1.4; margin: 0; padding-left: 16px;">
                                <li><strong>Level I+:</strong> Enhanced first aid capabilities</li>
                                <li><strong>Trauma Care:</strong> Tactical combat casualty care</li>
                                <li><strong>Surgical:</strong> Forward resuscitative surgery</li>
                                <li><strong>Specialty:</strong> Combat stress control, dental</li>
                            </ul>
                        </div>
                        ...
                        <div style="background-color: rgba(220, 38, 38, 0.15); padding: 12px; border-radius: 6px; border: 1px solid #ef4444;">
                            ...
                            <ul style="color: #d1d5db; font-size: 12px; line-height: 1.4; margin: 0; padding-left: 16px;">
                                <li><strong>MEDEVAC:</strong> MH-6M, MH-60M aircraft</li>
                                <li><strong>CASEVAC:</strong> Ground/air platforms</li>
                    ...
                    ">
                        <h4 style="font-size: 14px; font-weight: 600; color: white; margin: 0 0 12px 0; display: flex; align-items: center;">
                            ...
                            d. Regimental Planning
                        </h4>
                        <p style="color: #d1d5db; font-size: 13px; line-height: 1.4; margin: 0 0 16px 0;">
                            Regiment-level sustainment planning coordinating four battalion operations across 35-day campaign, integrating division requirements and specialized Ranger operations.
                        </p>
                        ...
                        <div style="background-color: rgba(147, 51, 234, 0.1); padding: 12px; border-radius: 6px; border: 1px solid #9333ea; margin-bottom: 16px;">
                            ...
                            <ul style="color: #d1d5db; font-size: 12px; line-height: 1.4; margin: 0; padding-left: 16px;">
                                <li><strong>Operational (10-35 days):</strong> Regiment planning</li>
                                <li><strong>Tactical (2-10 days):</strong> Battalion coordination</li>
                                <li><strong>Immediate (0-48 hours):</strong> Mission planning</li>
                                <li><strong>Crisis (0-8 hours):</strong> Emergency response</li>
                            </ul>
                        </div>
                        ...
                        <div style="background-color: rgba(76, 29, 149, 0.2); padding: 12px; border-radius: 6px; border: 1px solid #7c3aed; margin-bottom: 16px;">
                            ...
                            <ul style="color: #d1d5db; font-size: 12px; line-height: 1.4; margin: 0; padding-left: 16px;">
                                <li><strong>1/75:</strong> Ranger battalion operations</li>
                                <li><strong>2/75:</strong> Ranger battalion operations</li>
                                <li><strong>3/75:</strong> Ranger battalion operations</li>
                                <li><strong>STB:</strong> Special troops battalion</li>
                            </ul>
                        </div>
                        ...
                        <div style="background-color: rgba(124, 58, 237, 0.15); padding: 12px; border-radius: 6px; border: 1px solid #8b5cf6;">
                            ...
                            <ul style="color: #d1d5db; font-size: 12px; line-height: 1.4; margin: 0; padding-left: 16px;">
                                <li><strong>SOCOM C2:</strong> Special operations command control</li>
                                <li><strong>FBCB2:</strong> Force battle command</li>
                                <li><strong>GCSS-Army:</strong> Logistics planning</li>
                                <li><strong>JSOTF:</strong> Joint special operations coordination</li>
                            </ul>
                        </div>
                    </div>
                </div>

                <!-- Regiment Sustainment Command Structure -->
                <div style="background-color: #1f2937; border: 1px solid #374151; border-radius: 8px; padding: 20px; margin-bottom: 24px;">
                    <h4 style="font-size: 16px; font-weight: 600; color: white; margin: 0 0 16px 0; display: flex; align-items: center;">
                        ...
                        75th Ranger Regiment Sustainment Structure
                    </h4>

                    <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 16px; margin-bottom: 16px;">
                        <div style="background-color: #374151; padding: 12px; border-radius: 6px; border-left: 3px solid #f59e0b;">
                            <h5 style="color: #fbbf24; font-size: 12px; font-weight: 600; margin: 0 0 8px 0;">Regiment Level</h5>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                        <div>
                            <div style="background-color: #374151; padding: 12px; border-radius: 6px; border-left: 3px solid #ef4444; margin-bottom: 12px;">
                                <h5 style="color: #fca5a5; font-size: 12px; font-weight: 600; margin: 0 0 6px 0;">Phase I: Deployment (D-4 to D+3)</h5>
                                <ul style="color: #d1d5db; font-size: 12px; line-height: 1.3; margin: 0; padding-left: 16px;">
                                    <li>Regiment deployment: 3,800 personnel</li>
                                    <li>Equipment movement: 57K STONs</li>
                                    <li>Initial stocks: 6 DOS</li>
                                    <li>Airborne insertion: Multiple platforms</li>
                                </ul>
                            </div>
                            <div style="background-color: #374151; padding: 12px; border-radius: 6px; border-left: 3px solid #f59e0b; margin-bottom: 12px;">
                                <h5 style="color: #fbbf24; font-size: 12px; font-weight: 600; margin: 0 0 6px 0;">Phase II: Employment (D+4 to D+12)</h5>
                                <ul style="color: #d1d5db; font-size: 12px; line-height: 1.3; margin: 0; padding-left: 16px;">
                                    <li>Battalion deployment: 4 battalions operational</li>
                                    <li>Distribution network: 7 nodes active</li>
                                    <li>Medical facilities: Level I-II</li>
                                    <li>Sustainment stocks: 12 DOS</li>
                                </ul>
                            </div>
                        </div>
                        <div>
                            <div style="background-color: #374151; padding: 12px; border-radius: 6px; border-left: 3px solid #10b981; margin-bottom: 12px;">
                                <h5 style="color: #6ee7b7; font-size: 12px; font-weight: 600; margin: 0 0 6px 0;">Phase III: Operations (D+13 to D+28)</h5>
                                <ul style="color: #d1d5db; font-size: 12px; line-height: 1.3; margin: 0; padding-left: 16px;">
                                    <li>Steady-state: 3.6K STONs/day</li>
                                    <li>Coalition integration: 3 nations</li>
                                    <li>Host nation support: Limited</li>
                                    <li>Contractor support: 8%</li>
                                </ul>
                            </div>
                            <div style="background-color: #374151; padding: 12px; border-radius: 6px; border-left: 3px solid #3b82f6; margin-bottom: 12px;">
                                <h5 style="color: #93c5fd; font-size: 12px; font-weight: 600; margin: 0 0 6px 0;">Phase IV: Transition (D+29 to D+35)</h5>
                                <ul style="color: #d1d5db; font-size: 12px; line-height: 1.3; margin: 0; padding-left: 16px;">
                                    <li>Force adjustment: 18% reduction</li>
                                    <li>Equipment retrograde: 47K STONs</li>
                                    <li>Infrastructure handover: Division</li>
                                    <li>Lessons learned: Regiment level</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Regiment Sustainment Metrics -->
                <div style="background-color: #1f2937; border: 1px solid #374151; border-radius: 8px; padding: 20px; margin-bottom: 24px;">
                    <h4 style="font-size: 16px; font-weight: 600; color: white; margin: 0 0 16px 0; display: flex; align-items: center;">
                        <i class="fas fa-chart-line" style="margin-right: 8px; color: #06b6d4; font-size: 14px;"></i>
                        Key Regiment Sustainment Metrics
                    </h4>

                    <div style="display: grid; grid-template-columns: 1fr 1fr 1fr 1fr; gap: 12px; margin-bottom: 16px;">
                        <div style="background-color: #374151; padding: 12px; border-radius: 6px; text-align: center;">
                            <div style="color: #06b6d4; font-size: 20px; font-weight: 700; margin-bottom: 4px;">3,800+</div>
                            <div style="color: #d1d5db; font-size: 12px;">Total Personnel</div>
                        </div>
                        <div style="background-color: #374151; padding: 12px; border-radius: 6px; text-align: center;">
                            <div style="color: #10b981; font-size: 20px; font-weight: 700; margin-bottom: 4px;">3.6K</div>
                            <div style="color: #d1d5db; font-size: 12px;">STONs/Day Capacity</div>
                        </div>
                        <div style="background-color: #374151; padding: 12px; border-radius: 6px; text-align: center;">
                            <div style="color: #f59e0b; font-size: 20px; font-weight: 700; margin-bottom: 4px;">7</div>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                        <div style="background-color: rgba(6, 182, 212, 0.1); padding: 12px; border-radius: 6px; border: 1px solid #06b6d4;">
                            ...
                            <ul style="color: #d1d5db; font-size: 12px; line-height: 1.3; margin: 0; padding-left: 16px;">
                                <li>Supply availability: 95.4%</li>
                                <li>Distribution reliability: 92.8%</li>
                                <li>Transportation on-time: 89.7%</li>
                                <li>Inventory accuracy: 97.2%</li>
                            </ul>
                        </div>
                        <div style="background-color: rgba(16, 185, 129, 0.1); padding: 12px; border-radius: 6px; border: 1px solid #10b981;">
                            ...
                            <ul style="color: #d1d5db; font-size: 12px; line-height: 1.3; margin: 0; padding-left: 16px;">
                                <li>Survival rate: 96.7%</li>
                                <li>Golden hour compliance: 83.8%</li>
                                <li>MEDEVAC response: 20.4 min avg</li>
                                <li>Bed utilization: 70.6%</li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                        <div>
                            ...
                            <ul style="color: #bfdbfe; font-size: 12px; line-height: 1.3; margin: 0; padding-left: 16px;">
                                ...
                                <li>ATP 3-21.8 (Apr 2016): Infantry Platoon and Squad</li>
                        ...
                        <div>
                            ...
                            <ul style="color: #bfdbfe; font-size: 12px; line-height: 1.3; margin: 0; padding-left: 16px;">
                                ...
                                <li>ATP 3-21.20: Infantry Battalion</li>
                ...
                <div style="margin-top: 16px; padding: 12px; background-color: #065f46; border-radius: 6px; border-left: 3px solid #10b981;">
                    <p style="color: #6ee7b7; font-size: 12px; margin: 0; text-align: center;">
                        ...
                        UNCLASSIFIED - Regiment Level Sustainment Operations per FM 5-0 and FM 4-0 Standards
                    </p>
                </div>
            </div>
        `;
    ...
    initialize: function() {
        console.log('DEBUG: Regiment Sustainment Practical Examples module initialized');
        return true;
    }
};
