/**
 * JPP Step 5: Course of Action Comparison
...
import { detailedAnalysisModule } from './sections/coa-comparison-detailed-analysis.js';

export const coaComparisonContent = {
    title: "Step 5: COA Comparison",
    description: "Joint course of action comparison and decision matrix analysis",
    doctrine: `
        <div class="military-content">
                ...
                <div style="display:flex; align-items:center; justify-content:space-between;">
                    <div style="flex:1; padding-right:16px;">
                        <h1 style="font-size:20px; font-weight:bold; color:white; margin-bottom:4px;">
                            <i class="fas fa-balance-scale" style="margin-right:8px; color:#f59e0b;"></i>
                            5. Course of Action Comparison
                        </h1>
                        <p style="font-size:14px; color:#9ca3af;">Joint course of action comparison and decision matrix analysis</p>
                    </div>
                    <div style="background-color:#1e3a8a; border:1px solid #1d4ed8; border-radius:8px; padding:8px; min-width:192px; flex-shrink:0;">
                        <div style="color:#dbeafe; font-size:12px; line-height:1.4;">
                            <div>JP 5-0 (2017), Chapter 4, Para 4-5 — COA Comparison</div>
                            <div>JP 3-0 (2018), Chapter 3 — Decision Matrix Analysis</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="universal-jpp-coa-comparison-nav" style="margin-bottom: 16px;"></div>
...
export default coaComparisonContent;
