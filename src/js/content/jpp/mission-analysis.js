...
import { detailedAnalysisModule } from './sections/mission-analysis-detailed-analysis.js';

export const missionAnalysisContent = {
    title: "Step 2: Mission Analysis",
    description: "Joint mission analysis and comprehensive operational environment assessment",
    doctrine: `
        <div class="military-content">
                ...
                <div style="display:flex; align-items:center; justify-content:space-between;">
                    <div style="flex:1; padding-right:16px;">
                        <h1 style="font-size:20px; font-weight:bold; color:white; margin-bottom:4px;">
                            <i class="fas fa-search" style="margin-right:8px; color:#10b981;"></i>
                            2. Mission Analysis
                        </h1>
                        <p style="font-size:14px; color:#9ca3af;">Joint mission analysis and comprehensive operational environment assessment</p>
                    </div>
                    <div style="background-color:#1e3a8a; border:1px solid #1d4ed8; border-radius:8px; padding:8px; min-width:192px; flex-shrink:0;">
                        <div style="color:#dbeafe; font-size:12px; line-height:1.4;">
                            <div>JP 5-0 (2017), Chapter 4, Para 4-2 — Mission Analysis</div>
                            <div>JP 2-0 (2013), Chapter 3 — Joint Intelligence Preparation</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="universal-jpp-mission-analysis-nav" style="margin-bottom: 16px;"></div>
