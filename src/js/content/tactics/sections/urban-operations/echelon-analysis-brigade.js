/**
 * Brigade Combat Team-Level Urban Operations Echelon Analysis
 * Comprehensive doctrinal analysis for Brigade Combat Team-level urban operations
 * Command Level: Brigade Commander (Colonel, O-6)
 * Operational Scope: Brigade Combat Team operations, battalion coordination
...
export const brigadeTacticsModule = {
    getContent() {
        ...
        <div style="padding: 20px; background: #0f172a; min-height: 100vh;">
            <!-- Brigade Urban Operations Header -->
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 24px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                <h2 style="color: #f8fafc; font-size: 22px; font-weight: 700; margin: 0 0 20px 0; display: flex; align-items: center;">
                    ...
                    Brigade Combat Team Urban Operations: Tactical Execution and Leadership
                </h2>
                ...
                <div style="background: rgba(139, 92, 246, 0.1); border-left: 4px solid #8b5cf6; padding: 16px; border-radius: 6px;">
                    ...
                    <div style="color: #e9d5ff; font-size: 13px; line-height: 1.8; text-align: left; margin: 0; text-align: left;">
                        <p style="margin: 0 0 8px 0;"><strong>Tactical Command Level:</strong> Brigade Combat Team-level urban operations are conducted under the authority of Brigade Commanders (Colonel, O-6) with responsibility for tactical execution, multi-battalion coordination, and decisive operations across brigade tactical areas within complex urban environments.</p>
                        <p style="margin: 0; font-style: italic; font-size: 12px;"><strong>Doctrinal Foundation:</strong> Brigade urban operations doctrine is based on ATP 3-06 (Urban Operations), FM 3-0 (Operations), and JP 3-06 (Joint Urban Operations), emphasizing tactical leadership, decisive operations, and brigade-level integration in complex urban environments.</p>
                    </div>
                </div>
            </div>

            <!-- Brigade Combat Team Urban Operations Overview -->
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 24px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 16px;">
                    <div style="background: rgba(139, 92, 246, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(139, 92, 246, 0.3);">
                        <h4 style="color: #c4b5fd; font-size: 14px; font-weight: 600; margin: 0 0 14px 0;">
                            ...
                            TACTICAL LEADERSHIP DOCTRINE
                        </h4>
                        <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left; text-align: left;">
                            <p style="margin: 0 0 6px 0;"><strong>Brigade Urban Framework:</strong></p>
                            <p style="margin: 0 0 14px 0; padding-left: 12px;">Brigade Combat Team-level urban operations encompass tactical leadership and decisive operations across brigade tactical areas, requiring integration of battalion capabilities, joint enablers, and brigade support to achieve tactical objectives through synchronized multi-battalion operations in complex urban environments.</p>

                            <div style="border-top: 1px solid rgba(139, 92, 246, 0.2); padding-top: 12px;">
                                <p style="margin: 0 0 6px 0;"><strong>Tactical Leadership:</strong></p>
                                <p style="margin: 0; padding-left: 12px;">Brigade commanders must apply tactical leadership to sequence and synchronize battalion operations, allocate brigade resources across multiple urban areas, and coordinate with joint forces while maintaining tactical momentum and operational flexibility.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="background: rgba(37, 99, 235, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(37, 99, 235, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left; text-align: left;">
                            ...
                            <p style="margin: 0 0 14px 0; padding-left: 12px;">Brigade urban operations require seamless integration across multiple battalion areas, with urban environments serving as critical tactical nodes where battalion capabilities converge and interact in complex, interdependent relationships.</p>
                            ...
                            <div style="border-top: 1px solid rgba(37, 99, 235, 0.2); padding-top: 12px;">
                                ...
                                <p style="margin: 0; padding-left: 12px;">Brigade commanders must orchestrate multi-battalion effects to achieve decisive results, leveraging urban infrastructure, population centers, and information networks while protecting critical capabilities and maintaining tactical initiative.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div style="background: rgba(16, 185, 129, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(16, 185, 129, 0.3);">
                    <h4 style="color: #6ee7b7; font-size: 14px; font-weight: 600; margin: 0 0 14px 0;">
                        ...
                        TACTICAL LEADERSHIP IMPERATIVES
                    </h4>
                    <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 12px;">
                        <div style="background: rgba(16, 185, 129, 0.15); padding: 14px; border-radius: 6px; border: 1px solid rgba(16, 185, 129, 0.4);">
                            <h5 style="color: #6ee7b7; font-size: 13px; font-weight: 600; margin: 0 0 10px 0;">Decisive Operations</h5>
                            <div style="color: #d1d5db; font-size: 13px; line-height: 1.7; text-align: left; text-align: left;">
                                <ul style="margin: 0; padding-left: 20px; line-height: 1.7;">
                                    <li><strong>Brigade Mission</strong> — Brigade mission accomplishment</li>
                        ...
                        <div style="background: rgba(16, 185, 129, 0.15); padding: 14px; border-radius: 6px; border: 1px solid rgba(16, 185, 129, 0.4);">
                            ...
                            <div style="color: #d1d5db; font-size: 13px; line-height: 1.7; text-align: left; text-align: left;">
                                <ul style="margin: 0; padding-left: 20px; line-height: 1.7;">
                                    <li><strong>Force Protection</strong> — Brigade force protection and survivability</li>
                        ...
                        <div style="background: rgba(16, 185, 129, 0.15); padding: 14px; border-radius: 6px; border: 1px solid rgba(16, 185, 129, 0.4);">
                            ...
                            <div style="color: #d1d5db; font-size: 13px; line-height: 1.7; text-align: left; text-align: left;">
                                <ul style="margin: 0; padding-left: 20px; line-height: 1.7;">
                                    ...
                                    <li><strong>Resource Constraints</strong> — Brigade resource allocation</li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 24px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 16px;">
                    <div style="background: rgba(220, 38, 38, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(220, 38, 38, 0.3);">
                        <h4 style="color: #fca5a5; font-size: 14px; font-weight: 600; margin: 0 0 14px 0;">
                            ...
                            BRIGADE C2 FRAMEWORK
                        </h4>
                        <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left; text-align: left;">
                            <p style="margin: 0 0 6px 0;"><strong>Tactical Command Architecture:</strong></p>
                            <p style="margin: 0 0 14px 0; padding-left: 12px;">Brigade Combat Team-level command and control for urban operations requires robust, redundant, and resilient communication systems capable of coordinating multiple simultaneous battalion operations across brigade tactical areas while maintaining unity of command, unity of effort, and tactical security.</p>
                            ...
                            <div style="border-top: 1px solid rgba(220, 38, 38, 0.2); padding-top: 12px;">
                                ...
                                <p style="margin: 0; padding-left: 12px;">Integration of battalions, joint enablers, and brigade support command structures to achieve unity of effort across multiple urban tactical areas</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="background: rgba(245, 158, 11, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(245, 158, 11, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left; text-align: left;">
                            ...
                            <div style="border-top: 1px solid rgba(245, 158, 11, 0.2); padding-top: 12px;">
                                ...
                                <p style="margin: 0; padding-left: 12px;">Brigade intelligence platforms, tactical planning systems, real-time situational awareness, and tactical assessment tools</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                    <div style="background: rgba(99, 102, 241, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(99, 102, 241, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left; text-align: left;">
                            <p style="margin: 0 0 6px 0;"><strong>Brigade Command:</strong></p>
                            <p style="margin: 0 0 14px 0; padding-left: 12px;">Brigade Commander, Battalion Commanders, Joint Force Enablers, and Brigade Support Commands</p>
                            ...
                            <div style="border-top: 1px solid rgba(99, 102, 241, 0.2); padding-top: 12px;">
                                ...
                                <ul style="margin: 0 0 12px 0; padding-left: 20px; line-height: 1.8;">
                                    <li><strong>Brigade Command</strong> — Brigade command authority</li>
                    ...
                    <div style="background: rgba(139, 92, 246, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(139, 92, 246, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left; text-align: left;">
                            ...
                            <p style="margin: 0 0 14px 0; padding-left: 12px;">Brigade Operations Center (BOC), Brigade Intelligence Operations Center (BIOC), and Battalion Coordination Centers</p>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 16px;">
                    <div style="background: rgba(139, 92, 246, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(139, 92, 246, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left; text-align: left;">
                            ...
                            <p style="margin: 0 0 14px 0; padding-left: 12px;">Brigade Combat Team urban operations require integration with Air Force, Navy, Marine Corps, and Space Force capabilities at the tactical level, with each service contributing unique capabilities while maintaining unity of effort under brigade tactical control.</p>

                            <div style="border-top: 1px solid rgba(139, 92, 246, 0.2); padding-top: 12px;">
                                <p style="margin: 0 0 6px 0;"><strong>Joint Planning:</strong></p>
                                <p style="margin: 0; padding-left: 12px;">Brigade-level joint planning processes must accommodate service-specific capabilities and limitations while developing coherent, synchronized operations that leverage complementary strengths across all services.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="background: rgba(37, 99, 235, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(37, 99, 235, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left; text-align: left;">
                            ...
                            <p style="margin: 0 0 14px 0; padding-left: 12px;">Coalition urban operations require coordination with NATO allies, regional partners, and host nation forces at the brigade level, managing diverse capabilities and procedures while maintaining tactical effectiveness.</p>

                            <div style="border-top: 1px solid rgba(37, 99, 235, 0.2); padding-top: 12px;">
                                <p style="margin: 0 0 6px 0;"><strong>Interoperability Challenges:</strong></p>
                                <p style="margin: 0; padding-left: 12px;">Brigade commanders must address equipment compatibility, procedural differences, and varying rules of engagement while building coalition cohesion and shared understanding of tactical objectives.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 24px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                ...
                <div style="background: rgba(139, 92, 246, 0.1); border-left: 4px solid #8b5cf6; padding: 16px; border-radius: 6px;">
                    <h4 style="color: #c4b5fd; font-size: 14px; font-weight: 600; margin: 0 0 8px 0;">
                        <i class="fas fa-info-circle" style="margin-right: 8px;"></i>
                        BRIGADE MDO FRAMEWORK
                    </h4>
                    <div style="color: #e9d5ff; font-size: 13px; line-height: 1.8; text-align: left; margin: 0; text-align: left;">
                        <p style="margin: 0; font-style: italic; font-size: 12px;"><strong>Domain Convergence in Urban Environments:</strong> Brigade Combat Team-level urban operations represent critical convergence points for multi-domain operations, where land, air, maritime, space, and cyberspace domains intersect within battalion tactical areas, requiring sophisticated coordination and synchronization to achieve tactical objectives while managing cascading effects across all domains.</p>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 12px;">
                    <div style="background: rgba(16, 185, 129, 0.15); padding: 14px; border-radius: 6px; border: 1px solid rgba(16, 185, 129, 0.4);">
                        ...
                        <div style="color: #d1d5db; font-size: 13px; line-height: 1.7; text-align: left; text-align: left;">
                            <ul style="margin: 0; padding-left: 20px; line-height: 1.7;">
                                <li><strong>Ground Forces</strong> — Tactical ground force deployment</li>
                                <li><strong>Mobility</strong> — Brigade mobility corridors</li>
                    ...
                    <div style="background: rgba(16, 185, 129, 0.15); padding: 14px; border-radius: 6px; border: 1px solid rgba(16, 185, 129, 0.4);">
                        ...
                        <div style="color: #d1d5db; font-size: 13px; line-height: 1.7; text-align: left; text-align: left;">
                            <ul style="margin: 0; padding-left: 20px; line-height: 1.7;">
                                <li><strong>Air Support</strong> — Brigade air support operations</li>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-top: 16px;">
                    <div style="background: rgba(220, 38, 38, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(220, 38, 38, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left; text-align: left;">
                            <p style="margin: 0 0 6px 0;"><strong>Brigade Space Operations:</strong></p>
                    ...
                    <div style="background: rgba(245, 158, 11, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(245, 158, 11, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left; text-align: left;">
                            <p style="margin: 0 0 6px 0;"><strong>Brigade Cyber Operations:</strong></p>
            ...
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 24px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                ...
                <div style="background: rgba(139, 92, 246, 0.1); border-left: 4px solid #8b5cf6; padding: 16px; border-radius: 6px;">
                    <h4 style="color: #c4b5fd; font-size: 14px; font-weight: 600; margin: 0 0 8px 0;">
                        <i class="fas fa-info-circle" style="margin-right: 8px;"></i>
                        BRIGADE INTELLIGENCE FRAMEWORK
                    </h4>
                    <div style="color: #e9d5ff; font-size: 13px; line-height: 1.8; text-align: left; margin: 0; text-align: left;">
                        <p style="margin: 0; font-style: italic; font-size: 12px;"><strong>Tactical Intelligence Integration:</strong> Brigade Combat Team-level urban operations require comprehensive intelligence fusion from multiple sources, disciplines, and joint partners to provide tactical situational awareness, threat assessment, and decision support for complex urban environments across multiple battalion tactical areas and tactical time horizons.</p>
                    </div>
                </div>
                ...
                <div style="background: rgba(16, 185, 129, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(16, 185, 129, 0.3);">
                    ...
                    <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left; text-align: left;">
                        ...
                        <div style="border-top: 1px solid rgba(16, 185, 129, 0.2); padding-top: 12px;">
                            ...
                            <p style="margin: 0; padding-left: 12px;">Brigade Combat Team urban operations doctrine continues to evolve in response to emerging threats, technological advances, and lessons learned from contemporary operations, requiring continuous adaptation and refinement to maintain relevance and effectiveness in an increasingly complex and urbanized tactical environment.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 24px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 16px;">
                    <div style="background: rgba(220, 38, 38, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(220, 38, 38, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left; text-align: left;">
                            <p style="margin: 0 0 6px 0;"><strong>Brigade Fires Coordination:</strong></p>
                            <p style="margin: 0 0 14px 0; padding-left: 12px;">Tactical fires in urban environments require precise coordination across multiple battalions and domains to achieve tactical objectives while minimizing collateral damage, protecting civilian populations, and preserving critical infrastructure.</p>

                            <div style="border-top: 1px solid rgba(220, 38, 38, 0.2); padding-top: 12px;">
                                <p style="margin: 0 0 6px 0;"><strong>Effects-Based Operations:</strong></p>
                                <p style="margin: 0; padding-left: 12px;">Brigade commanders must orchestrate lethal and non-lethal effects to achieve tactical objectives, considering second and third-order effects across complex urban systems and networks.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="background: rgba(245, 158, 11, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(245, 158, 11, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left; text-align: left;">
                            ...
                            <p style="margin: 0 0 14px 0; padding-left: 12px;">Urban targeting at brigade level requires comprehensive analysis of target systems, collateral damage estimation, legal review processes, and tactical communication considerations to maintain legitimacy and effectiveness.</p>
                        ...
                        <div style="background: rgba(16, 185, 129, 0.15); padding: 14px; border-radius: 6px; border: 1px solid rgba(16, 185, 129, 0.4);">
                            ...
                            <div style="color: #d1d5db; font-size: 13px; line-height: 1.7; text-align: left; text-align: left;">
                                <ul style="margin: 0; padding-left: 20px; line-height: 1.7;">
                                    ...
                                    <li><strong>Artillery</strong> — Brigade artillery operations</li>
                                    <li><strong>Aviation Fires</strong> — Brigade aviation fires</li>
                                </ul>
                            </div>
                        </div>
                        <div style="background: rgba(16, 185, 129, 0.15); padding: 14px; border-radius: 6px; border: 1px solid rgba(16, 185, 129, 0.4);">
            ...
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 24px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                ...
                <div style="background: rgba(139, 92, 246, 0.1); border-left: 4px solid #8b5cf6; padding: 16px; border-radius: 6px;">
                    ...
                    <div style="color: #e9d5ff; font-size: 13px; line-height: 1.8; text-align: left; margin: 0; text-align: left;">
                        <p style="margin: 0; font-style: italic; font-size: 12px;"><strong>Brigade Logistics Architecture:</strong> Brigade Combat Team-level urban operations require comprehensive sustainment architecture capable of supporting multiple simultaneous battalion operations across brigade tactical areas, integrating tactical lift capabilities, brigade distribution networks, and tactical sustainment operations while overcoming urban terrain challenges and security threats.</p>
                    </div>
                </div>
                ...
                <div style="background: rgba(16, 185, 129, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(16, 185, 129, 0.3); margin-top: 16px;">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr 1fr 1fr; gap: 12px;">
                        <div style="background: rgba(16, 185, 129, 0.15); padding: 14px; border-radius: 6px; border: 1px solid rgba(16, 185, 129, 0.4);">
                            ...
                            <div style="color: #d1d5db; font-size: 13px; line-height: 1.7; text-align: left; text-align: left;">
                                <ul style="margin: 0; padding-left: 20px; line-height: 1.7;">
                                    <li><strong>Brigade Supply</strong> — Brigade supply operations</li>
                        ...
                        <div style="background: rgba(16, 185, 129, 0.15); padding: 14px; border-radius: 6px; border: 1px solid rgba(16, 185, 129, 0.4);">
                            ...
                            <div style="color: #d1d5db; font-size: 13px; line-height: 1.7; text-align: left; text-align: left;">
                                <ul style="margin: 0; padding-left: 20px; line-height: 1.7;">
                                    ...
                                    <li><strong>Ground Transport</strong> — Brigade ground transportation</li>
                                </ul>
                            </div>
                        </div>
                        <div style="background: rgba(16, 185, 129, 0.15); padding: 14px; border-radius: 6px; border: 1px solid rgba(16, 185, 129, 0.4);">
                            ...
                            <div style="color: #d1d5db; font-size: 13px; line-height: 1.7; text-align: left; text-align: left;">
                                <ul style="margin: 0; padding-left: 20px; line-height: 1.7;">
                                    <li><strong>Brigade Maint</strong> — Brigade maintenance operations</li>
                        ...
                        <div style="background: rgba(16, 185, 129, 0.15); padding: 14px; border-radius: 6px; border: 1px solid rgba(16, 185, 129, 0.4);">
                            ...
                            <div style="color: #d1d5db; font-size: 13px; line-height: 1.7; text-align: left; text-align: left;">
                                <ul style="margin: 0; padding-left: 20px; line-height: 1.7;">
                                    <li><strong>Brigade Medical</strong> — Brigade medical operations</li>
