/**
 * Tactics: Reconnaissance & Security - Echelon Analysis (Brigade Level)
 * Doctrinal Analysis and Planning Framework for Brigade-Level Reconnaissance and Security Operations
 * Classification: UNCLASSIFIED//FOR OFFICIAL USE ONLY
 * Command Level: Brigade Commander (Colonel O-6)
 ...
 * Target: 60,000-70,000 characters of brigade-level doctrinal reconnaissance and security analysis
 */
        ...
        <div style="padding: 20px; background: #0f172a; min-height: 100vh;">
            ...
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 24px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                <h2 style="color: #f8fafc; font-size: 22px; font-weight: 700; margin: 0 0 20px 0; display: flex; align-items: center;">
                    <i class="fas fa-chess-rook" style="margin-right: 12px; color: #a855f7; font-size: 20px;"></i>
                    Brigade-Level Reconnaissance and Security Operations: Doctrinal Analysis and Planning Framework
                </h2>
                ...
                <div style="background: rgba(168, 85, 247, 0.15); padding: 20px; border-radius: 10px; border: 1px solid rgba(168, 85, 247, 0.4);">
                    ...
                    <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                        <p style="margin: 0;"><strong>Command Level:</strong> Brigade Commander (Colonel O-6) commanding 3,000-5,000 personnel across 5,000-15,000 km² operational area with 3-7 day planning horizon. Brigade-level reconnaissance and security operations provide operational intelligence enabling battalion operations and supporting division tactical objectives across multiple battalion task force areas of operations.</p>
                    </div>
                </div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 20px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                <h3 style="color: #f8fafc; font-size: 18px; font-weight: 600; margin: 0 0 16px 0; display: flex; align-items: center;">
                    ...
                    Fundamental Principles of Brigade Reconnaissance and Security Operations
                </h3>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                    <div style="background: rgba(96, 165, 250, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(96, 165, 250, 0.3);">
                        <h4 style="color: #93c5fd; font-size: 16px; font-weight: 600; margin: 0 0 14px 0;">
                            ...
                            Seven Principles of Brigade Reconnaissance
                        </h4>
                        <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                            <ul style="margin: 0; padding-left: 20px;">
                                <li style="margin-bottom: 8px;"><strong>Orient on Operational Objectives:</strong> Focus on brigade commander's operational priorities</li>
                    ...
                    <div style="background: rgba(34, 197, 94, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(34, 197, 94, 0.3);">
                        <h4 style="color: #86efac; font-size: 16px; font-weight: 600; margin: 0 0 14px 0;">
                            ...
                            Five Principles of Brigade Security Operations
                        </h4>
                        <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                            <ul style="margin: 0; padding-left: 20px;">
                                <li style="margin-bottom: 8px;"><strong>Provide Early and Accurate Warning:</strong> Alert battalion commanders 3-6 hours in advance</li>
            ...
            <!-- Brigade Reconnaissance Planning Framework -->
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 20px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                <h3 style="color: #f8fafc; font-size: 18px; font-weight: 600; margin: 0 0 16px 0; display: flex; align-items: center;">
                    <i class="fas fa-map-marked-alt" style="margin-right: 10px; color: #a855f7; font-size: 16px;"></i>
                    Brigade Reconnaissance Planning Framework (FM 3-20, FM 3-0)
                </h3>
                ...
                <div style="background: rgba(168, 85, 247, 0.15); padding: 20px; border-radius: 10px; border: 1px solid rgba(168, 85, 247, 0.4); margin-bottom: 20px;">
                    <h4 style="color: #c4b5fd; font-size: 16px; font-weight: 600; margin: 0 0 14px 0;">Brigade Reconnaissance Planning Doctrine</h4>
                    <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                        <p style="margin: 0 0 14px 0;"><strong>Doctrinal Foundation:</strong> Brigade reconnaissance planning follows MDMP per FM 5-0 and integrates with division reconnaissance operations. Brigade commanders develop reconnaissance plans supporting operational objectives across 2-4 battalion task force areas of operations. Planning accounts for operational depth (15-50 km), multiple subordinate battalions, and integration with division ISR assets over 3-7 day operational timelines. The brigade S2 serves as the primary staff officer responsible for reconnaissance planning, coordinating with the S3 for operational integration and synchronizing with division S2 for higher echelon ISR support.</p>

                        <p style="margin: 0 0 14px 0;"><strong>Planning Process:</strong> The brigade S2 leads reconnaissance planning through four phases: (1) Operational Reconnaissance Planning - define brigade PIR based on operational objectives; (2) ISR Asset Allocation - assign division and battalion ISR assets to collection requirements; (3) Reconnaissance Synchronization - integrate operations across battalion areas; (4) Execution and Assessment - conduct operations and assess effectiveness against PIR. Each phase requires close coordination between brigade staff, battalion S2 sections, and division S2 to ensure comprehensive intelligence coverage across the brigade area of operations.</p>

                        <p style="margin: 0 0 14px 0;"><strong>Commander's Role:</strong> The brigade commander provides reconnaissance guidance during mission analysis, approves brigade PIR, and prioritizes intelligence requirements based on operational objectives. The commander's reconnaissance guidance shapes the entire planning process, ensuring reconnaissance operations directly support the brigade's operational mission and enable battalion task force operations across multiple areas of operations.</p>

                        <p style="margin: 0;"><strong>Integration with Division:</strong> Brigade reconnaissance planning must integrate seamlessly with division tactical plans and corps operational objectives. The brigade S2 coordinates with division S2 to request ISR support, deconflict collection operations, and ensure brigade PIR support division intelligence requirements. This vertical integration ensures reconnaissance operations at all echelons support the overall operational plan while avoiding duplication of effort and maximizing ISR asset utilization across the division area of operations.</p>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-top: 16px;">
                    <div>
                        ...
                        <ul style="margin: 0 0 14px 0; padding-left: 20px; line-height: 1.8; color: #e5e7eb; font-size: 13px;">
                            <li><strong>Step 1:</strong> Analyze brigade operational objectives</li>
                            <li><strong>Step 2:</strong> Develop brigade PIR and IR</li>
                        ...
                        <ul style="margin: 0; padding-left: 20px; line-height: 1.8; color: #e5e7eb; font-size: 13px;">
                            ...
                            <li><strong>Step 2:</strong> Allocate brigade reconnaissance troop</li>
                    ...
                    <div>
                        ...
                        <ul style="margin: 0; padding-left: 20px; line-height: 1.8; color: #e5e7eb; font-size: 13px;">
                            ...
                            <li><strong>Step 5:</strong> Update brigade intelligence estimate</li>
                        </ul>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 16px; margin-top: 20px;">
                    <div style="background: rgba(96, 165, 250, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(96, 165, 250, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 12px; line-height: 1.7; text-align: left;">
                            ...
                            <ul style="margin: 0 0 12px 0; padding-left: 16px;">
                                <li style="margin-bottom: 4px;">Brigade decisive points and objectives</li>
                            ...
                            <ul style="margin: 0; padding-left: 16px;">
                                ...
                                <li style="margin-bottom: 4px;">Brigade commander's intent</li>
                    ...
                    <div style="background: rgba(34, 197, 94, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(34, 197, 94, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 12px; line-height: 1.7; text-align: left;">
                            <p style="margin: 0 0 6px 0;"><strong>Brigade PIR Categories:</strong></p>
                            <ul style="margin: 0 0 12px 0; padding-left: 16px;">
                            ...
                            <ul style="margin: 0; padding-left: 16px;">
                                <li style="margin-bottom: 4px;">Brigade commander approval</li>
                    ...
                    <div style="background: rgba(245, 158, 11, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(245, 158, 11, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 12px; line-height: 1.7; text-align: left;">
                            <p style="margin: 0 0 6px 0;"><strong>Brigade ISR Assets:</strong></p>
                            <ul style="margin: 0 0 12px 0; padding-left: 16px;">
                                <li style="margin-bottom: 4px;">Brigade reconnaissance troop</li>
            ...
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 20px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                <h3 style="color: #f8fafc; font-size: 18px; font-weight: 600; margin: 0 0 16px 0; display: flex; align-items: center;">
                    ...
                    Brigade ISR Integration and Synchronization (FM 3-0, ATP 2-01.3)
                </h3>

                <div style="background: rgba(168, 85, 247, 0.15); padding: 20px; border-radius: 10px; border: 1px solid rgba(168, 85, 247, 0.4); margin-bottom: 20px;">
                    <h4 style="color: #c4b5fd; font-size: 16px; font-weight: 600; margin: 0 0 14px 0;">ISR Synchronization Framework</h4>
                    <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                        <p style="margin: 0 0 14px 0;"><strong>Brigade ISR Synchronization:</strong> Brigade S2 integrates division ISR support with battalion reconnaissance operations through the Intelligence Collection Management (ICM) process. Synchronization ensures optimal employment of ISR assets across multiple battalion areas while supporting brigade operational objectives and division tactical plans. The brigade ISR synchronization meeting coordinates collection, processing, exploitation, and dissemination (CPED) across all echelons.</p>

                        <p style="margin: 0 0 14px 0;"><strong>Synchronization Meeting:</strong> The brigade ISR synchronization meeting brings together S2, S3, battalion S2 representatives, and division S2 liaison officers to coordinate reconnaissance operations. The meeting reviews current intelligence collection, assesses PIR satisfaction, identifies intelligence gaps, reallocates ISR assets as needed, and synchronizes future collection operations. This forum ensures all echelons understand collection priorities and coordinate reconnaissance efforts across the brigade area of operations.</p>

                        <p style="margin: 0;"><strong>Collection Management:</strong> The brigade S2 collection manager oversees the Intelligence Collection Management process, tracking all ISR assets, monitoring collection effectiveness, and adjusting collection priorities based on changing operational requirements. Collection management ensures ISR assets are employed efficiently, intelligence gaps are identified and addressed, and reconnaissance operations remain synchronized with brigade operational plans across 3-7 day planning horizons.</p>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                    <div style="background: rgba(96, 165, 250, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(96, 165, 250, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                            ...
                            <ul style="margin: 0 0 14px 0; padding-left: 20px; line-height: 1.8;">
                                ...
                                <li><strong>Battalion:</strong> Battalion S2 integrates brigade and company ISR</li>
                            </ul>
                            ...
                            <div style="border-top: 1px solid rgba(96, 165, 250, 0.2); padding-top: 12px;">
                                ...
                                <ul style="margin: 0; padding-left: 20px; line-height: 1.8;">
                                    <li><strong>PIR Flow:</strong> Battalion to brigade to division</li>
                                    <li><strong>Intelligence Products:</strong> Division to brigade to battalion</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="background: rgba(34, 197, 94, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(34, 197, 94, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                            ...
                            <ul style="margin: 0 0 14px 0; padding-left: 20px; line-height: 1.8;">
                                <li><strong>Multiple Battalions:</strong> Coordinate ISR across 2-4 battalions</li>
                                <li><strong>Brigade Reconnaissance:</strong> Brigade-level reconnaissance troop</li>
                            ...
                            <div style="border-top: 1px solid rgba(34, 197, 94, 0.2); padding-top: 12px;">
                                ...
                                <ul style="margin: 0; padding-left: 20px; line-height: 1.8;">
                                    <li><strong>Brigade S2:</strong> Brigade intelligence operations</li>
                                    <li><strong>ISR Sync Meeting:</strong> Brigade ISR coordination</li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 20px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                ...
                <div style="background: rgba(168, 85, 247, 0.15); padding: 20px; border-radius: 10px; border: 1px solid rgba(168, 85, 247, 0.4); margin-bottom: 20px;">
                    <h4 style="color: #c4b5fd; font-size: 16px; font-weight: 600; margin: 0 0 14px 0;">Multi-Domain Operations at Brigade Level</h4>
                    <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                        <p style="margin: 0 0 14px 0;"><strong>Brigade Multi-Domain Reconnaissance:</strong> Brigade-level reconnaissance integrates capabilities across land, air, and cyber domains per FM 3-0. Brigade commanders leverage division ISR assets, battalion reconnaissance forces, and brigade-organic capabilities to create comprehensive operational intelligence supporting multiple battalion operations across 15-50 km operational depth. Multi-domain integration enables brigade commanders to exploit adversary vulnerabilities across all domains simultaneously, creating operational dilemmas that adversary forces cannot effectively counter.</p>

                        <p style="margin: 0 0 14px 0;"><strong>Integration Approach:</strong> Multi-domain reconnaissance synchronizes collection across all domains to create operational intelligence advantage. Brigade S2 coordinates with division S2, aviation assets, and cyber support to integrate reconnaissance operations. This integration enables brigade commanders to understand adversary capabilities across all domains and exploit vulnerabilities through synchronized multi-domain operations.</p>

                        <p style="margin: 0;"><strong>Operational Application:</strong> At brigade level, multi-domain reconnaissance typically combines ground reconnaissance (brigade reconnaissance troop, battalion scouts), aerial reconnaissance (division UAS, brigade UAS), and cyber reconnaissance (network intelligence, EW operations). This combination provides comprehensive operational intelligence that no single domain could provide independently, enabling brigade commanders to make informed operational decisions across multiple battalion areas of operations.</p>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 16px;">
                    ...
                    <div style="background: rgba(34, 197, 94, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(34, 197, 94, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 12px; line-height: 1.7; text-align: left;">
                            ...
                            <ul style="margin: 0 0 12px 0; padding-left: 16px;">
                                <li style="margin-bottom: 4px;">Division UAS support</li>
                                <li style="margin-bottom: 4px;">Brigade UAS (RQ-11 Raven)</li>
                            </ul>
            ...
            <!-- Brigade Security Operations Doctrine -->
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 20px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                <h3 style="color: #f8fafc; font-size: 18px; font-weight: 600; margin: 0 0 16px 0; display: flex; align-items: center;">
                    <i class="fas fa-shield-alt" style="margin-right: 10px; color: #a855f7; font-size: 16px;"></i>
                    Brigade Security Operations Doctrine (FM 3-20, FM 3-0)
                </h3>

                <div style="background: rgba(168, 85, 247, 0.15); padding: 20px; border-radius: 10px; border: 1px solid rgba(168, 85, 247, 0.4); margin-bottom: 20px;">
                    <h4 style="color: #c4b5fd; font-size: 16px; font-weight: 600; margin: 0 0 14px 0;">Security Operations Framework</h4>
                    <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                        <p style="margin: 0 0 14px 0;"><strong>Brigade Security Operations:</strong> Per FM 3-20, brigade security operations provide protection to battalion forces, enable freedom of maneuver, and deny adversary intelligence collection across operational depth. Security operations include screen, guard, and area security conducted at operational distances (10-30 km) protecting multiple battalion operations across the brigade area of operations.</p>

                        <p style="margin: 0;"><strong>Planning Considerations:</strong> Brigade security operations must account for operational depth, multiple battalion boundaries, and integration with division security operations. Security forces typically include brigade reconnaissance troop, battalion scouts, and company reconnaissance elements. Planning must balance force protection requirements against reconnaissance mission needs and ensure adequate early warning time (3-6 hours) for battalion commanders to react to adversary threats.</p>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 16px;">
                    <div style="background: rgba(96, 165, 250, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(96, 165, 250, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 12px; line-height: 1.7; text-align: left;">
                            ...
                            <ul style="margin: 0; padding-left: 16px;">
                                <li style="margin-bottom: 4px;">Brigade flanks and boundaries</li>
                    ...
                    <div style="background: rgba(34, 197, 94, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(34, 197, 94, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 12px; line-height: 1.7; text-align: left;">
                            ...
                            <ul style="margin: 0; padding-left: 16px;">
                                ...
                                <li style="margin-bottom: 4px;">Brigade assembly areas</li>
                            </ul>
                        </div>
                    </div>
            ...
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 20px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                ...
                <div style="background: rgba(168, 85, 247, 0.15); padding: 20px; border-radius: 10px; border: 1px solid rgba(168, 85, 247, 0.4); margin-bottom: 20px;">
                    <h4 style="color: #c4b5fd; font-size: 16px; font-weight: 600; margin: 0 0 14px 0;">Brigade IPB Process</h4>
                    <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                        <p style="margin: 0 0 14px 0;"><strong>IPB at Brigade Level:</strong> Intelligence Preparation of the Battlefield (IPB) per ATP 2-01.3 is the systematic process of analyzing the operational environment, adversary capabilities, and terrain to support brigade commander decision-making. Brigade S2 conducts IPB across 5,000-15,000 km² operational area, integrating division intelligence products with battalion-level analysis to create comprehensive operational intelligence supporting multiple battalion operations.</p>

                        <p style="margin: 0 0 14px 0;"><strong>IPB Products:</strong> Brigade IPB produces operational intelligence products including Modified Combined Obstacle Overlay (MCOO), Situation Template (SITEMP), Event Template, and Decision Support Template (DST). These products support brigade commander decision-making by identifying adversary capabilities, likely courses of action, and decision points requiring commander action. Brigade S2 disseminates IPB products to battalion S2 sections to support battalion-level planning and operations.</p>

                        <p style="margin: 0;"><strong>Continuous Process:</strong> IPB is not a one-time event but a continuous process throughout operations. Brigade S2 continuously updates IPB products based on new intelligence, changing operational conditions, and adversary actions. This continuous IPB process ensures brigade commanders maintain current understanding of the operational environment and can adapt plans based on changing conditions across the 3-7 day operational timeline.</p>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                    <div style="background: rgba(96, 165, 250, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(96, 165, 250, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                            ...
                            <ul style="margin: 0 0 14px 0; padding-left: 20px; line-height: 1.8;">
                                <li>Define brigade AO (5,000-15,000 km²)</li>
                                <li>Identify brigade AOI (15-50 km depth)</li>
                            </ul>
            ...
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 20px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                ...
                <div style="background: rgba(168, 85, 247, 0.15); padding: 20px; border-radius: 10px; border: 1px solid rgba(168, 85, 247, 0.4); margin-bottom: 20px;">
                    <h4 style="color: #c4b5fd; font-size: 16px; font-weight: 600; margin: 0 0 14px 0;">Brigade Reconnaissance-Strike Operations</h4>
                    <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                        <p style="margin: 0 0 14px 0;"><strong>Integration Framework:</strong> Reconnaissance-strike operations integrate brigade reconnaissance capabilities with fires and maneuver to rapidly detect, identify, and engage high-value targets. Brigade S2 and S3 coordinate through the F2T2EA cycle, synchronizing ISR assets with brigade fires and battalion maneuver to create operational effects across multiple battalion areas.</p>

                        <p style="margin: 0 0 14px 0;"><strong>Targeting Process:</strong> Brigade reconnaissance-strike operations follow the D3A targeting methodology (Decide, Detect, Deliver, Assess). The brigade commander decides on high-value targets based on operational objectives. Brigade ISR assets detect targets through reconnaissance operations. Brigade fires or battalion maneuver deliver effects against targets. Brigade S2 assesses battle damage and determines if additional targeting is required. This process creates rapid operational effects against adversary forces.</p>

                        <p style="margin: 0;"><strong>Synchronization Requirements:</strong> Effective reconnaissance-strike operations require close synchronization between brigade S2 (intelligence), S3 (operations), and fire support coordinator (fires). The brigade targeting meeting coordinates reconnaissance-strike operations, ensuring ISR assets are positioned to detect high-value targets, fires are available to engage targets, and battle damage assessment is conducted to verify effects. This synchronization enables brigade commanders to rapidly engage adversary forces across operational depth.</p>
                    </div>
                </div>
            ...
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 24px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                <h3 style="color: #f8fafc; font-size: 18px; font-weight: 600; margin: 0 0 16px 0; display: flex; align-items: center;">
                    ...
                    Brigade Reconnaissance and Security Operations: Doctrinal Summary
                </h3>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 16px;">
                    <div style="background: rgba(168, 85, 247, 0.15); padding: 18px; border-radius: 8px; border: 1px solid rgba(168, 85, 247, 0.4);">
                        ...
                        <div style="color: #e5e7eb; font-size: 12px; line-height: 1.7; text-align: left;">
                            <ul style="margin: 0; padding-left: 16px;">
                                <li style="margin-bottom: 6px;"><strong>Integration:</strong> Synchronize division and battalion ISR</li>
                                <li style="margin-bottom: 6px;"><strong>Coordination:</strong> Integrate multiple battalion operations</li>
                                <li style="margin-bottom: 6px;"><strong>Prioritization:</strong> Focus on brigade PIR</li>
                    ...
                    <div style="background: rgba(168, 85, 247, 0.15); padding: 18px; border-radius: 8px; border: 1px solid rgba(168, 85, 247, 0.4);">
                        ...
                        <div style="color: #e5e7eb; font-size: 12px; line-height: 1.7; text-align: left;">
                            <ul style="margin: 0; padding-left: 16px;">
                                <li style="margin-bottom: 6px;"><strong>Inadequate Coordination:</strong> Failing to integrate division and battalion ISR</li>
                ...
                <div style="background: rgba(168, 85, 247, 0.2); padding: 20px; border-radius: 10px; border: 1px solid rgba(168, 85, 247, 0.5); margin-top: 20px;">
                    ...
                    <p style="color: #e5e7eb; font-size: 14px; line-height: 1.8; margin: 0; text-align: center; font-style: italic;">
                        "Brigade-level reconnaissance and security operations provide the operational intelligence foundation enabling battalion task force operations and supporting division tactical objectives. Success requires seamless integration of division ISR support with battalion reconnaissance operations, synchronized through comprehensive planning, continuous coordination, and rapid intelligence dissemination across multiple battalion areas of operations."
                    </p>
