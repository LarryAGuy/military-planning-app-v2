/**
 * Tactics: Reconnaissance & Security - Echelon Analysis (Battalion Level)
 * Doctrinal Analysis and Planning Framework for Battalion-Level Reconnaissance and Security Operations
 ...
 * Target: 55,000-65,000 characters of battalion-level doctrinal reconnaissance and security analysis
 */
        ...
        <div style="padding: 20px; background: #0f172a; min-height: 100vh;">
            ...
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 24px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                <h2 style="color: #f8fafc; font-size: 22px; font-weight: 700; margin: 0 0 20px 0; display: flex; align-items: center;">
                    <i class="fas fa-flag" style="margin-right: 12px; color: #a855f7; font-size: 20px;"></i>
                    Battalion-Level Reconnaissance and Security Operations: Doctrinal Analysis and Planning Framework
                </h2>
                ...
                <div style="background: rgba(168, 85, 247, 0.15); padding: 20px; border-radius: 10px; border: 1px solid rgba(168, 85, 247, 0.4);">
                    ...
                    <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                        <p style="margin: 0;"><strong>Command Level:</strong> Battalion Commander (Lieutenant Colonel O-5) commanding 300-1,000 personnel across 500-3,000 km² operational area with 24-72 hour planning horizon. Battalion-level reconnaissance and security operations provide tactical intelligence enabling company operations and supporting brigade operational objectives. Battalions execute direct reconnaissance and security missions, engaging adversary forces to develop the situation and protect friendly forces across multiple company areas of operations.</p>
                    </div>
                </div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 20px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                <h3 style="color: #f8fafc; font-size: 18px; font-weight: 600; margin: 0 0 16px 0; display: flex; align-items: center;">
                    ...
                    Fundamental Principles of Battalion Reconnaissance and Security Operations
                </h3>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                    <div style="background: rgba(96, 165, 250, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(96, 165, 250, 0.3);">
                        <h4 style="color: #93c5fd; font-size: 16px; font-weight: 600; margin: 0 0 14px 0;">
                            ...
                            Seven Principles of Battalion Reconnaissance
                        </h4>
                        <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                            <ul style="margin: 0; padding-left: 20px;">
                                <li style="margin-bottom: 8px;"><strong>Orient on Tactical Objectives:</strong> Focus on battalion commander's tactical priorities</li>
                                <li style="margin-bottom: 8px;"><strong>Report Information Rapidly:</strong> Disseminate intelligence within company decision cycles</li>
                                ...
                                <li style="margin-bottom: 8px;"><strong>Employ Multiple Assets:</strong> Integrate company and platoon reconnaissance</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div style="background: rgba(34, 197, 94, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(34, 197, 94, 0.3);">
                        <h4 style="color: #86efac; font-size: 16px; font-weight: 600; margin: 0 0 14px 0;">
                            ...
                            Five Principles of Battalion Security Operations
                        </h4>
                        <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                            <ul style="margin: 0; padding-left: 20px;">
                                <li style="margin-bottom: 8px;"><strong>Provide Early and Accurate Warning:</strong> Alert company commanders 1-3 hours in advance</li>
                                <li style="margin-bottom: 8px;"><strong>Provide Reaction Time and Maneuver Space:</strong> Enable companies to deploy forces</li>
                                <li style="margin-bottom: 8px;"><strong>Orient on the Protected Force:</strong> Security focused on protecting company operations</li>
            ...
            <!-- Battalion Reconnaissance Planning Framework -->
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 20px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                <h3 style="color: #f8fafc; font-size: 18px; font-weight: 600; margin: 0 0 16px 0; display: flex; align-items: center;">
                    <i class="fas fa-map-marked-alt" style="margin-right: 10px; color: #a855f7; font-size: 16px;"></i>
                    Battalion Reconnaissance Planning Framework (FM 3-20, FM 3-0)
                </h3>
                ...
                <div style="background: rgba(168, 85, 247, 0.15); padding: 20px; border-radius: 10px; border: 1px solid rgba(168, 85, 247, 0.4); margin-bottom: 20px;">
                    <h4 style="color: #c4b5fd; font-size: 16px; font-weight: 600; margin: 0 0 14px 0;">Battalion Reconnaissance Planning Doctrine</h4>
                    <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                        <p style="margin: 0 0 14px 0;"><strong>Doctrinal Foundation:</strong> Battalion reconnaissance planning follows Troop Leading Procedures (TLP) per FM 3-21.8 and integrates with brigade reconnaissance operations. Battalion commanders develop reconnaissance plans supporting tactical objectives across 3-5 company areas of operations. Planning accounts for tactical depth (5-15 km), multiple subordinate companies, and integration with brigade ISR assets over 24-72 hour tactical timelines. The battalion S2 serves as the primary staff officer responsible for reconnaissance planning, coordinating with the S3 for tactical integration and synchronizing with brigade S2 for operational ISR support.</p>

                        <p style="margin: 0 0 14px 0;"><strong>Planning Process:</strong> The battalion S2 leads reconnaissance planning through four phases: (1) Tactical Reconnaissance Planning - define battalion PIR based on tactical objectives; (2) ISR Asset Allocation - assign brigade and company ISR assets to collection requirements; (3) Reconnaissance Synchronization - integrate operations across company areas; (4) Execution and Assessment - conduct operations and assess effectiveness against PIR. Each phase requires close coordination between battalion staff, company commanders, and brigade S2 to ensure comprehensive intelligence coverage across the battalion area of operations.</p>

                        <p style="margin: 0;"><strong>Commander's Role:</strong> The battalion commander provides reconnaissance guidance during mission analysis, approves battalion PIR, and prioritizes intelligence requirements based on tactical objectives. The commander's reconnaissance guidance shapes the entire planning process, ensuring reconnaissance operations directly support the battalion's tactical mission and enable company operations across multiple areas of operations within the 24-72 hour planning horizon.</p>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-top: 16px;">
                    <div>
                        ...
                        <ul style="margin: 0 0 14px 0; padding-left: 20px; line-height: 1.8; color: #e5e7eb; font-size: 13px;">
                            <li><strong>Step 1:</strong> Analyze battalion tactical objectives</li>
                            <li><strong>Step 2:</strong> Develop battalion PIR and IR</li>
                            <li><strong>Step 3:</strong> Identify intelligence gaps</li>
                            <li><strong>Step 4:</strong> Coordinate with brigade S2</li>
                            <li><strong>Step 5:</strong> Integrate company reconnaissance requirements</li>
                        </ul>
                        ...
                        <ul style="margin: 0; padding-left: 20px; line-height: 1.8; color: #e5e7eb; font-size: 13px;">
                            <li><strong>Step 1:</strong> Request brigade ISR support</li>
                            <li><strong>Step 2:</strong> Allocate battalion scout platoon</li>
                            <li><strong>Step 3:</strong> Assign company reconnaissance assets</li>
                    ...
                    <div>
                        ...
                        <ul style="margin: 0 0 14px 0; padding-left: 20px; line-height: 1.8; color: #e5e7eb; font-size: 13px;">
                            <li><strong>Step 1:</strong> Synchronize company reconnaissance operations</li>
                            <li><strong>Step 2:</strong> Integrate brigade ISR support</li>
                        ...
                        <ul style="margin: 0; padding-left: 20px; line-height: 1.8; color: #e5e7eb; font-size: 13px;">
                            ...
                            <li><strong>Step 5:</strong> Update battalion intelligence estimate</li>
                        </ul>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 16px; margin-top: 20px;">
                    <div style="background: rgba(96, 165, 250, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(96, 165, 250, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 12px; line-height: 1.7; text-align: left;">
                            ...
                            <ul style="margin: 0 0 12px 0; padding-left: 16px;">
                                <li style="margin-bottom: 4px;">Battalion decisive points</li>
                            ...
                            <ul style="margin: 0; padding-left: 16px;">
                                <li style="margin-bottom: 4px;">Brigade operational objectives</li>
                                <li style="margin-bottom: 4px;">Battalion commander's intent</li>
                                <li style="margin-bottom: 4px;">Company mission requirements</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div style="background: rgba(34, 197, 94, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(34, 197, 94, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 12px; line-height: 1.7; text-align: left;">
                            <p style="margin: 0 0 6px 0;"><strong>Battalion PIR Categories:</strong></p>
                            <ul style="margin: 0 0 12px 0; padding-left: 16px;">
                            ...
                            <ul style="margin: 0; padding-left: 16px;">
                                <li style="margin-bottom: 4px;">Battalion commander approval</li>
                                <li style="margin-bottom: 4px;">Company PIR integration</li>
                                <li style="margin-bottom: 4px;">Brigade PIR coordination</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div style="background: rgba(245, 158, 11, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(245, 158, 11, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 12px; line-height: 1.7; text-align: left;">
                            <p style="margin: 0 0 6px 0;"><strong>Battalion ISR Assets:</strong></p>
                            <ul style="margin: 0 0 12px 0; padding-left: 16px;">
                                <li style="margin-bottom: 4px;">Battalion scout platoon</li>
                                <li style="margin-bottom: 4px;">Brigade UAS support</li>
                                <li style="margin-bottom: 4px;">Company scouts</li>
                                <li style="margin-bottom: 4px;">Platoon reconnaissance</li>
                            </ul>

                            <p style="margin: 0 0 6px 0;"><strong>Allocation Process:</strong></p>
                            <ul style="margin: 0; padding-left: 16px;">
                                <li style="margin-bottom: 4px;">Company priority assignment</li>
                                <li style="margin-bottom: 4px;">Brigade asset coordination</li>
            ...
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 20px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                <h3 style="color: #f8fafc; font-size: 18px; font-weight: 600; margin: 0 0 16px 0; display: flex; align-items: center;">
                    ...
                    Battalion ISR Integration and Synchronization (FM 3-0, ATP 2-01.3)
                </h3>

                <div style="background: rgba(168, 85, 247, 0.15); padding: 20px; border-radius: 10px; border: 1px solid rgba(168, 85, 247, 0.4); margin-bottom: 20px;">
                    <h4 style="color: #c4b5fd; font-size: 16px; font-weight: 600; margin: 0 0 14px 0;">ISR Synchronization Framework</h4>
                    <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                        <p style="margin: 0 0 14px 0;"><strong>Battalion ISR Synchronization:</strong> Battalion S2 integrates brigade ISR support with company reconnaissance operations through tactical collection management. Synchronization ensures optimal employment of ISR assets across multiple company areas while supporting battalion tactical objectives and brigade operational plans. The battalion ISR synchronization meeting coordinates collection, processing, exploitation, and dissemination (CPED) across all tactical echelons within the 24-72 hour planning horizon.</p>

                        <p style="margin: 0;"><strong>Collection Management:</strong> The battalion S2 collection manager oversees tactical collection management, tracking all ISR assets, monitoring collection effectiveness, and adjusting collection priorities based on changing tactical requirements. Collection management ensures ISR assets are employed efficiently, intelligence gaps are identified and addressed, and reconnaissance operations remain synchronized with battalion tactical plans across the 24-72 hour timeline.</p>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                    <div style="background: rgba(96, 165, 250, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(96, 165, 250, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                            ...
                            <ul style="margin: 0 0 14px 0; padding-left: 20px; line-height: 1.8;">
                                <li><strong>Brigade:</strong> Brigade S2 provides operational ISR support</li>
                            ...
                            <div style="border-top: 1px solid rgba(96, 165, 250, 0.2); padding-top: 12px;">
                                ...
                                <ul style="margin: 0; padding-left: 20px; line-height: 1.8;">
                                    <li><strong>PIR Flow:</strong> Company to battalion to brigade</li>
                                    <li><strong>Intelligence Products:</strong> Brigade to battalion to company</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="background: rgba(34, 197, 94, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(34, 197, 94, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                            <p style="margin: 0 0 6px 0;"><strong>Company Integration:</strong></p>
                            <ul style="margin: 0 0 14px 0; padding-left: 20px; line-height: 1.8;">
                                <li><strong>Multiple Companies:</strong> Coordinate ISR across 3-5 companies</li>
                                <li><strong>Battalion Scouts:</strong> Battalion-level scout platoon</li>
                                <li><strong>Brigade Support:</strong> Brigade ISR asset coordination</li>
                            </ul>
                            ...
                            <div style="border-top: 1px solid rgba(34, 197, 94, 0.2); padding-top: 12px;">
                                ...
                                <ul style="margin: 0; padding-left: 20px; line-height: 1.8;">
                                    <li><strong>Battalion S2:</strong> Battalion intelligence operations</li>
                                    <li><strong>ISR Sync Meeting:</strong> Battalion ISR coordination</li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 20px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                ...
                <div style="background: rgba(168, 85, 247, 0.15); padding: 20px; border-radius: 10px; border: 1px solid rgba(168, 85, 247, 0.4); margin-bottom: 20px;">
                    <h4 style="color: #c4b5fd; font-size: 16px; font-weight: 600; margin: 0 0 14px 0;">Multi-Domain Operations at Battalion Level</h4>
                    <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                        <p style="margin: 0;"><strong>Battalion Multi-Domain Reconnaissance:</strong> Battalion-level reconnaissance integrates capabilities across land, air, and cyber domains per FM 3-0. Battalion commanders leverage brigade ISR assets, company reconnaissance forces, and battalion-organic capabilities to create comprehensive tactical intelligence supporting multiple company operations across 5-15 km tactical depth. Multi-domain integration enables battalion commanders to exploit adversary vulnerabilities across all domains simultaneously within the 24-72 hour planning horizon.</p>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 16px;">
                    ...
                    <div style="background: rgba(34, 197, 94, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(34, 197, 94, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 12px; line-height: 1.7; text-align: left;">
                            ...
                            <ul style="margin: 0 0 12px 0; padding-left: 16px;">
                                <li style="margin-bottom: 4px;">Brigade UAS support</li>
                                <li style="margin-bottom: 4px;">Battalion UAS (RQ-11 Raven)</li>
                            </ul>
            ...
            <!-- Battalion Security Operations Doctrine -->
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 20px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                <h3 style="color: #f8fafc; font-size: 18px; font-weight: 600; margin: 0 0 16px 0; display: flex; align-items: center;">
                    <i class="fas fa-shield-alt" style="margin-right: 10px; color: #a855f7; font-size: 16px;"></i>
                    Battalion Security Operations Doctrine (FM 3-20, FM 3-0)
                </h3>

                <div style="background: rgba(168, 85, 247, 0.15); padding: 20px; border-radius: 10px; border: 1px solid rgba(168, 85, 247, 0.4); margin-bottom: 20px;">
                    <h4 style="color: #c4b5fd; font-size: 16px; font-weight: 600; margin: 0 0 14px 0;">Security Operations Framework</h4>
                    <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                        <p style="margin: 0;"><strong>Battalion Security Operations:</strong> Per FM 3-20, battalion security operations provide protection to company forces, enable freedom of maneuver, and deny adversary intelligence collection across tactical depth. Security operations include screen, guard, and area security conducted at tactical distances (3-10 km) protecting multiple company operations across the battalion area of operations within the 24-72 hour planning horizon.</p>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 16px;">
                    <div style="background: rgba(96, 165, 250, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(96, 165, 250, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 12px; line-height: 1.7; text-align: left;">
                            ...
                            <ul style="margin: 0; padding-left: 16px;">
                                <li style="margin-bottom: 4px;">Battalion flanks and boundaries</li>
                                <li style="margin-bottom: 4px;">Company boundary security</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div style="background: rgba(34, 197, 94, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(34, 197, 94, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 12px; line-height: 1.7; text-align: left;">
                            <p style="margin: 0 0 6px 0;"><strong>Purpose:</strong></p>
                            <ul style="margin: 0 0 12px 0; padding-left: 16px;">
                                <li style="margin-bottom: 4px;">Protect company forces</li>
                                <li style="margin-bottom: 4px;">Fight to gain time</li>
                            </ul>

                            <p style="margin: 0 0 6px 0;"><strong>Applications:</strong></p>
                            <ul style="margin: 0; padding-left: 16px;">
                                <li style="margin-bottom: 4px;">Company force protection</li>
                                <li style="margin-bottom: 4px;">Battalion assembly areas</li>
                            </ul>
                        </div>
                    </div>
            ...
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 20px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                ...
                <div style="background: rgba(168, 85, 247, 0.15); padding: 20px; border-radius: 10px; border: 1px solid rgba(168, 85, 247, 0.4); margin-bottom: 20px;">
                    <h4 style="color: #c4b5fd; font-size: 16px; font-weight: 600; margin: 0 0 14px 0;">Battalion IPB Process</h4>
                    <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                        <p style="margin: 0;"><strong>IPB at Battalion Level:</strong> Intelligence Preparation of the Battlefield (IPB) per ATP 2-01.3 is the systematic process of analyzing the tactical environment, adversary capabilities, and terrain to support battalion commander decision-making. Battalion S2 conducts IPB across 500-3,000 km² tactical area, integrating brigade intelligence products with company-level analysis to create comprehensive tactical intelligence supporting multiple company operations within the 24-72 hour planning horizon.</p>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                    <div style="background: rgba(96, 165, 250, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(96, 165, 250, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                            ...
                            <ul style="margin: 0 0 14px 0; padding-left: 20px; line-height: 1.8;">
                                <li>Define battalion AO (500-3,000 km²)</li>
                                <li>Identify battalion AOI (5-15 km depth)</li>
                            </ul>
            ...
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 20px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                ...
                <div style="background: rgba(168, 85, 247, 0.15); padding: 20px; border-radius: 10px; border: 1px solid rgba(168, 85, 247, 0.4); margin-bottom: 20px;">
                    <h4 style="color: #c4b5fd; font-size: 16px; font-weight: 600; margin: 0 0 14px 0;">Battalion Reconnaissance-Strike Operations</h4>
                    <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                        <p style="margin: 0;"><strong>Integration Framework:</strong> Reconnaissance-strike operations integrate battalion reconnaissance capabilities with fires and maneuver to rapidly detect, identify, and engage high-value targets. Battalion S2 and S3 coordinate through the F2T2EA cycle, synchronizing ISR assets with battalion fires and company maneuver to create tactical effects across multiple company areas within the 24-72 hour planning horizon.</p>
                    </div>
                </div>
                    ...
                    <div style="background: rgba(96, 165, 250, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(96, 165, 250, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 12px; line-height: 1.7; text-align: left;">
                            ...
                            <ul style="margin: 0; padding-left: 16px;">
                                ...
                                <li style="margin-bottom: 4px;">Multiple company operations</li>
                                <li style="margin-bottom: 4px;">Brigade ISR integration</li>
                    ...
                    <div style="background: rgba(245, 158, 11, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(245, 158, 11, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 12px; line-height: 1.7; text-align: left;">
                            ...
                            <ul style="margin: 0; padding-left: 16px;">
                                ...
                                <li style="margin-bottom: 4px;">Brigade ISR support</li>
            ...
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 24px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                <h3 style="color: #f8fafc; font-size: 18px; font-weight: 600; margin: 0 0 16px 0; display: flex; align-items: center;">
                    ...
                    Battalion Reconnaissance and Security Operations: Doctrinal Summary
                </h3>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 16px;">
                    <div style="background: rgba(168, 85, 247, 0.15); padding: 18px; border-radius: 8px; border: 1px solid rgba(168, 85, 247, 0.4);">
                        ...
                        <div style="color: #e5e7eb; font-size: 12px; line-height: 1.7; text-align: left;">
                            <ul style="margin: 0; padding-left: 16px;">
                                <li style="margin-bottom: 6px;"><strong>Integration:</strong> Synchronize brigade and company ISR</li>
                                <li style="margin-bottom: 6px;"><strong>Coordination:</strong> Integrate multiple company operations</li>
                                <li style="margin-bottom: 6px;"><strong>Prioritization:</strong> Focus on battalion PIR</li>
                    ...
                    <div style="background: rgba(168, 85, 247, 0.15); padding: 18px; border-radius: 8px; border: 1px solid rgba(168, 85, 247, 0.4);">
                        ...
                        <div style="color: #e5e7eb; font-size: 12px; line-height: 1.7; text-align: left;">
                            <ul style="margin: 0; padding-left: 16px;">
                                ...
                                <li style="margin-bottom: 6px;"><strong>Brigade Integration:</strong> Coordinate with brigade S2 early</li>
                                <li style="margin-bottom: 6px;"><strong>Company Coordination:</strong> Integrate company requirements</li>
                    ...
                    <div style="background: rgba(168, 85, 247, 0.15); padding: 18px; border-radius: 8px; border: 1px solid rgba(168, 85, 247, 0.4);">
                        ...
                        <div style="color: #e5e7eb; font-size: 12px; line-height: 1.7; text-align: left;">
                            <ul style="margin: 0; padding-left: 16px;">
                                <li style="margin-bottom: 6px;"><strong>Inadequate Coordination:</strong> Failing to integrate brigade and company ISR</li>
                ...
                <div style="background: rgba(168, 85, 247, 0.2); padding: 20px; border-radius: 10px; border: 1px solid rgba(168, 85, 247, 0.5); margin-top: 20px;">
                    ...
                    <p style="color: #e5e7eb; font-size: 14px; line-height: 1.8; margin: 0; text-align: center; font-style: italic;">
                        "Battalion-level reconnaissance and security operations provide the tactical intelligence foundation enabling company operations and supporting brigade operational objectives. Success requires seamless integration of brigade ISR support with company reconnaissance operations, synchronized through comprehensive planning, continuous coordination, and rapid intelligence dissemination across multiple company areas of operations within the 24-72 hour planning horizon."
                    </p>
