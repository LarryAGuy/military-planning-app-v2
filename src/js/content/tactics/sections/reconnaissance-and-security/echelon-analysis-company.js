/**
 * Tactics: Reconnaissance & Security - Echelon Analysis (Company Level)
 * Doctrinal Analysis and Planning Framework for Company-Level Reconnaissance and Security Operations
 ...
 * Target: 55,000-65,000 characters of company-level doctrinal reconnaissance and security analysis
 */
        ...
        <div style="padding: 20px; background: #0f172a; min-height: 100vh;">
            ...
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 24px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                <h2 style="color: #f8fafc; font-size: 22px; font-weight: 700; margin: 0 0 20px 0; display: flex; align-items: center;">
                    <i class="fas fa-user-friends" style="margin-right: 12px; color: #a855f7; font-size: 20px;"></i>
                    Company-Level Reconnaissance and Security Operations: Doctrinal Analysis and Planning Framework
                </h2>
                ...
                <div style="background: rgba(168, 85, 247, 0.15); padding: 20px; border-radius: 10px; border: 1px solid rgba(168, 85, 247, 0.4);">
                    ...
                    <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                        <p style="margin: 0;"><strong>Command Level:</strong> Company Commander (Captain O-3) commanding 60-200 personnel across 100-500 km² operational area with 12-24 hour planning horizon. Company-level reconnaissance and security operations provide tactical intelligence enabling platoon operations and supporting battalion tactical objectives. Companies execute direct reconnaissance and security missions, engaging adversary forces to develop the situation and protect friendly forces across multiple platoon areas of operations.</p>
                    </div>
                </div>
            </div>
            ...
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 20px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                <h3 style="color: #f8fafc; font-size: 18px; font-weight: 600; margin: 0 0 16px 0; display: flex; align-items: center;">
                    ...
                    Fundamental Principles of Company Reconnaissance and Security Operations
                </h3>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                    <div style="background: rgba(96, 165, 250, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(96, 165, 250, 0.3);">
                        <h4 style="color: #93c5fd; font-size: 16px; font-weight: 600; margin: 0 0 14px 0;">
                            ...
                            Seven Principles of Company Reconnaissance
                        </h4>
                        <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                            <ul style="margin: 0; padding-left: 20px;">
                                <li style="margin-bottom: 8px;"><strong>Orient on Tactical Objectives:</strong> Focus on company commander's tactical priorities</li>
                                <li style="margin-bottom: 8px;"><strong>Report Information Rapidly:</strong> Disseminate intelligence within platoon decision cycles</li>
                                ...
                                <li style="margin-bottom: 8px;"><strong>Employ Multiple Assets:</strong> Integrate platoon and squad reconnaissance</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div style="background: rgba(34, 197, 94, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(34, 197, 94, 0.3);">
                        <h4 style="color: #86efac; font-size: 16px; font-weight: 600; margin: 0 0 14px 0;">
                            ...
                            Five Principles of Company Security Operations
                        </h4>
                        <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                            <ul style="margin: 0; padding-left: 20px;">
                                <li style="margin-bottom: 8px;"><strong>Provide Early and Accurate Warning:</strong> Alert platoon leaders 30-60 minutes in advance</li>
                                <li style="margin-bottom: 8px;"><strong>Provide Reaction Time and Maneuver Space:</strong> Enable platoons to deploy forces</li>
                                <li style="margin-bottom: 8px;"><strong>Orient on the Protected Force:</strong> Security focused on protecting platoon operations</li>
            ...
            <!-- Company Reconnaissance Planning Framework -->
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 20px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                <h3 style="color: #f8fafc; font-size: 18px; font-weight: 600; margin: 0 0 16px 0; display: flex; align-items: center;">
                    <i class="fas fa-map-marked-alt" style="margin-right: 10px; color: #a855f7; font-size: 16px;"></i>
                    Company Reconnaissance Planning Framework (FM 3-20, FM 3-0)
                </h3>
                ...
                <div style="background: rgba(168, 85, 247, 0.15); padding: 20px; border-radius: 10px; border: 1px solid rgba(168, 85, 247, 0.4); margin-bottom: 20px;">
                    <h4 style="color: #c4b5fd; font-size: 16px; font-weight: 600; margin: 0 0 14px 0;">Company Reconnaissance Planning Doctrine</h4>
                    <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                        <p style="margin: 0 0 14px 0;"><strong>Doctrinal Foundation:</strong> Company reconnaissance planning follows Troop Leading Procedures (TLP) per FM 3-21.8 and integrates with battalion reconnaissance operations. Company commanders develop reconnaissance plans supporting tactical objectives across 2-4 platoon areas of operations. Planning accounts for tactical depth (1-5 km), multiple subordinate platoons, and integration with battalion ISR assets over 12-24 hour tactical timelines. The company executive officer (XO) often assists with reconnaissance planning, coordinating with battalion S2 for tactical integration and synchronizing with platoon leaders for execution.</p>

                        <p style="margin: 0 0 14px 0;"><strong>Planning Process:</strong> The company commander leads reconnaissance planning through four phases: (1) Tactical Reconnaissance Planning - define company PIR based on tactical objectives; (2) ISR Asset Allocation - assign battalion and platoon ISR assets to collection requirements; (3) Reconnaissance Synchronization - integrate operations across platoon areas; (4) Execution and Assessment - conduct operations and assess effectiveness against PIR. Each phase requires close coordination between company leadership, platoon leaders, and battalion S2 to ensure comprehensive intelligence coverage across the company area of operations.</p>

                        <p style="margin: 0;"><strong>Commander's Role:</strong> The company commander provides reconnaissance guidance during mission analysis, approves company PIR, and prioritizes intelligence requirements based on tactical objectives. The commander's reconnaissance guidance shapes the entire planning process, ensuring reconnaissance operations directly support the company's tactical mission and enable platoon operations across multiple areas of operations within the 12-24 hour planning horizon.</p>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-top: 16px;">
                    <div>
                        ...
                        <ul style="margin: 0 0 14px 0; padding-left: 20px; line-height: 1.8; color: #e5e7eb; font-size: 13px;">
                            <li><strong>Step 1:</strong> Analyze company tactical objectives</li>
                            <li><strong>Step 2:</strong> Develop company PIR and IR</li>
                            <li><strong>Step 3:</strong> Identify intelligence gaps</li>
                            <li><strong>Step 4:</strong> Coordinate with battalion S2</li>
                            <li><strong>Step 5:</strong> Integrate platoon reconnaissance requirements</li>
                        </ul>
                        ...
                        <ul style="margin: 0; padding-left: 20px; line-height: 1.8; color: #e5e7eb; font-size: 13px;">
                            <li><strong>Step 1:</strong> Request battalion ISR support</li>
                            <li><strong>Step 2:</strong> Allocate company scout section</li>
                            <li><strong>Step 3:</strong> Assign platoon reconnaissance assets</li>
                    ...
                    <div>
                        ...
                        <ul style="margin: 0 0 14px 0; padding-left: 20px; line-height: 1.8; color: #e5e7eb; font-size: 13px;">
                            <li><strong>Step 1:</strong> Synchronize platoon reconnaissance operations</li>
                            <li><strong>Step 2:</strong> Integrate battalion ISR support</li>
                        ...
                        <ul style="margin: 0; padding-left: 20px; line-height: 1.8; color: #e5e7eb; font-size: 13px;">
                            ...
                            <li><strong>Step 5:</strong> Update company intelligence estimate</li>
                        </ul>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 16px; margin-top: 20px;">
                    <div style="background: rgba(96, 165, 250, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(96, 165, 250, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 12px; line-height: 1.7; text-align: left;">
                            ...
                            <ul style="margin: 0 0 12px 0; padding-left: 16px;">
                                <li style="margin-bottom: 4px;">Company decisive points</li>
                                <li style="margin-bottom: 4px;">Platoon tactical objectives</li>
                            ...
                            <ul style="margin: 0; padding-left: 16px;">
                                <li style="margin-bottom: 4px;">Battalion tactical objectives</li>
                                <li style="margin-bottom: 4px;">Company commander's intent</li>
                                <li style="margin-bottom: 4px;">Platoon mission requirements</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div style="background: rgba(34, 197, 94, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(34, 197, 94, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 12px; line-height: 1.7; text-align: left;">
                            <p style="margin: 0 0 6px 0;"><strong>Company PIR Categories:</strong></p>
                            <ul style="margin: 0 0 12px 0; padding-left: 16px;">
                                <li style="margin-bottom: 4px;">Adversary platoon-level formations</li>
                                <li style="margin-bottom: 4px;">Enemy tactical positions</li>
                                <li style="margin-bottom: 4px;">Mortar positions</li>
                            ...
                            <ul style="margin: 0; padding-left: 16px;">
                                <li style="margin-bottom: 4px;">Company commander approval</li>
                                <li style="margin-bottom: 4px;">Platoon PIR integration</li>
                                <li style="margin-bottom: 4px;">Battalion PIR coordination</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div style="background: rgba(245, 158, 11, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(245, 158, 11, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 12px; line-height: 1.7; text-align: left;">
                            <p style="margin: 0 0 6px 0;"><strong>Company ISR Assets:</strong></p>
                            <ul style="margin: 0 0 12px 0; padding-left: 16px;">
                                <li style="margin-bottom: 4px;">Company scout section</li>
                                <li style="margin-bottom: 4px;">Battalion UAS support</li>
                                <li style="margin-bottom: 4px;">Platoon scouts</li>
                                <li style="margin-bottom: 4px;">Squad reconnaissance</li>
                            </ul>

                            <p style="margin: 0 0 6px 0;"><strong>Allocation Process:</strong></p>
                            <ul style="margin: 0; padding-left: 16px;">
                                <li style="margin-bottom: 4px;">Platoon priority assignment</li>
                                <li style="margin-bottom: 4px;">Battalion asset coordination</li>
            ...
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 20px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                <h3 style="color: #f8fafc; font-size: 18px; font-weight: 600; margin: 0 0 16px 0; display: flex; align-items: center;">
                    ...
                    Company ISR Integration and Synchronization (FM 3-0, ATP 2-01.3)
                </h3>

                <div style="background: rgba(168, 85, 247, 0.15); padding: 20px; border-radius: 10px; border: 1px solid rgba(168, 85, 247, 0.4); margin-bottom: 20px;">
                    <h4 style="color: #c4b5fd; font-size: 16px; font-weight: 600; margin: 0 0 14px 0;">ISR Synchronization Framework</h4>
                    <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                        <p style="margin: 0 0 14px 0;"><strong>Company ISR Synchronization:</strong> Company commander integrates battalion ISR support with platoon reconnaissance operations through tactical collection management. Synchronization ensures optimal employment of ISR assets across multiple platoon areas while supporting company tactical objectives and battalion tactical plans. The company ISR synchronization meeting coordinates collection, processing, exploitation, and dissemination (CPED) across all tactical echelons within the 12-24 hour planning horizon.</p>

                        <p style="margin: 0;"><strong>Collection Management:</strong> The company XO often oversees tactical collection management, tracking all ISR assets, monitoring collection effectiveness, and adjusting collection priorities based on changing tactical requirements. Collection management ensures ISR assets are employed efficiently, intelligence gaps are identified and addressed, and reconnaissance operations remain synchronized with company tactical plans across the 12-24 hour timeline.</p>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                    <div style="background: rgba(96, 165, 250, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(96, 165, 250, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                            ...
                            <ul style="margin: 0 0 14px 0; padding-left: 20px; line-height: 1.8;">
                                <li><strong>Battalion:</strong> Battalion S2 provides tactical ISR support</li>
                                <li><strong>Company:</strong> Company commander integrates battalion and platoon ISR</li>
                            ...
                            <div style="border-top: 1px solid rgba(96, 165, 250, 0.2); padding-top: 12px;">
                                ...
                                <ul style="margin: 0; padding-left: 20px; line-height: 1.8;">
                                    <li><strong>PIR Flow:</strong> Platoon to company to battalion</li>
                                    <li><strong>Intelligence Products:</strong> Battalion to company to platoon</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <div style="background: rgba(34, 197, 94, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(34, 197, 94, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                            <p style="margin: 0 0 6px 0;"><strong>Platoon Integration:</strong></p>
                            <ul style="margin: 0 0 14px 0; padding-left: 20px; line-height: 1.8;">
                                <li><strong>Multiple Platoons:</strong> Coordinate ISR across 2-4 platoons</li>
                                <li><strong>Company Scouts:</strong> Company-level scout section</li>
                                <li><strong>Battalion Support:</strong> Battalion ISR asset coordination</li>
                            </ul>
                            ...
                            <div style="border-top: 1px solid rgba(34, 197, 94, 0.2); padding-top: 12px;">
                                ...
                                <ul style="margin: 0; padding-left: 20px; line-height: 1.8;">
                                    <li><strong>Company XO:</strong> Company intelligence operations</li>
                                    <li><strong>ISR Sync Meeting:</strong> Company ISR coordination</li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 20px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                ...
                <div style="background: rgba(168, 85, 247, 0.15); padding: 20px; border-radius: 10px; border: 1px solid rgba(168, 85, 247, 0.4); margin-bottom: 20px;">
                    <h4 style="color: #c4b5fd; font-size: 16px; font-weight: 600; margin: 0 0 14px 0;">Multi-Domain Operations at Company Level</h4>
                    <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                        <p style="margin: 0;"><strong>Company Multi-Domain Reconnaissance:</strong> Company-level reconnaissance integrates capabilities across land, air, and cyber domains per FM 3-0. Company commanders leverage battalion ISR assets, platoon reconnaissance forces, and company-organic capabilities to create comprehensive tactical intelligence supporting multiple platoon operations across 1-5 km tactical depth. Multi-domain integration enables company commanders to exploit adversary vulnerabilities across all domains simultaneously within the 12-24 hour planning horizon.</p>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 16px;">
                    ...
                    <div style="background: rgba(34, 197, 94, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(34, 197, 94, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 12px; line-height: 1.7; text-align: left;">
                            ...
                            <ul style="margin: 0 0 12px 0; padding-left: 16px;">
                                <li style="margin-bottom: 4px;">Battalion UAS support</li>
                                <li style="margin-bottom: 4px;">Company UAS (RQ-11 Raven)</li>
                            </ul>
            ...
            <!-- Company Security Operations Doctrine -->
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 20px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                <h3 style="color: #f8fafc; font-size: 18px; font-weight: 600; margin: 0 0 16px 0; display: flex; align-items: center;">
                    <i class="fas fa-shield-alt" style="margin-right: 10px; color: #a855f7; font-size: 16px;"></i>
                    Company Security Operations Doctrine (FM 3-20, FM 3-0)
                </h3>

                <div style="background: rgba(168, 85, 247, 0.15); padding: 20px; border-radius: 10px; border: 1px solid rgba(168, 85, 247, 0.4); margin-bottom: 20px;">
                    <h4 style="color: #c4b5fd; font-size: 16px; font-weight: 600; margin: 0 0 14px 0;">Security Operations Framework</h4>
                    <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                        <p style="margin: 0;"><strong>Company Security Operations:</strong> Per FM 3-20, company security operations provide protection to platoon forces, enable freedom of maneuver, and deny adversary intelligence collection across tactical depth. Security operations include screen, guard, and area security conducted at tactical distances (1-3 km) protecting multiple platoon operations across the company area of operations within the 12-24 hour planning horizon.</p>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 16px;">
                    <div style="background: rgba(96, 165, 250, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(96, 165, 250, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 12px; line-height: 1.7; text-align: left;">
                            ...
                            <ul style="margin: 0 0 12px 0; padding-left: 16px;">
                                <li style="margin-bottom: 4px;">Early warning (30-60 minutes)</li>
                            ...
                            <ul style="margin: 0; padding-left: 16px;">
                                <li style="margin-bottom: 4px;">Company flanks and boundaries</li>
                                <li style="margin-bottom: 4px;">Platoon boundary security</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div style="background: rgba(34, 197, 94, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(34, 197, 94, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 12px; line-height: 1.7; text-align: left;">
                            <p style="margin: 0 0 6px 0;"><strong>Purpose:</strong></p>
                            <ul style="margin: 0 0 12px 0; padding-left: 16px;">
                                <li style="margin-bottom: 4px;">Protect platoon forces</li>
                                <li style="margin-bottom: 4px;">Fight to gain time</li>
                            </ul>

                            <p style="margin: 0 0 6px 0;"><strong>Applications:</strong></p>
                            <ul style="margin: 0; padding-left: 16px;">
                                <li style="margin-bottom: 4px;">Platoon force protection</li>
                                <li style="margin-bottom: 4px;">Company assembly areas</li>
                            </ul>
                        </div>
                    </div>
            ...
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 20px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                ...
                <div style="background: rgba(168, 85, 247, 0.15); padding: 20px; border-radius: 10px; border: 1px solid rgba(168, 85, 247, 0.4); margin-bottom: 20px;">
                    <h4 style="color: #c4b5fd; font-size: 16px; font-weight: 600; margin: 0 0 14px 0;">Company IPB Process</h4>
                    <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                        <p style="margin: 0;"><strong>IPB at Company Level:</strong> Intelligence Preparation of the Battlefield (IPB) per ATP 2-01.3 is the systematic process of analyzing the tactical environment, adversary capabilities, and terrain to support company commander decision-making. Company commander conducts IPB across 100-500 km² tactical area, integrating battalion intelligence products with platoon-level analysis to create comprehensive tactical intelligence supporting multiple platoon operations within the 12-24 hour planning horizon.</p>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                    <div style="background: rgba(96, 165, 250, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(96, 165, 250, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                            ...
                            <ul style="margin: 0 0 14px 0; padding-left: 20px; line-height: 1.8;">
                                <li>Define company AO (100-500 km²)</li>
                                <li>Identify company AOI (1-5 km depth)</li>
                            </ul>
                    ...
                    <div style="background: rgba(34, 197, 94, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(34, 197, 94, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                            ...
                            <ul style="margin: 0 0 14px 0; padding-left: 20px; line-height: 1.8;">
                                <li>Adversary platoon formations</li>
            ...
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 20px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                ...
                <div style="background: rgba(168, 85, 247, 0.15); padding: 20px; border-radius: 10px; border: 1px solid rgba(168, 85, 247, 0.4); margin-bottom: 20px;">
                    <h4 style="color: #c4b5fd; font-size: 16px; font-weight: 600; margin: 0 0 14px 0;">Company Reconnaissance-Strike Operations</h4>
                    <div style="color: #e5e7eb; font-size: 13px; line-height: 1.8; text-align: left;">
                        <p style="margin: 0;"><strong>Integration Framework:</strong> Reconnaissance-strike operations integrate company reconnaissance capabilities with fires and maneuver to rapidly detect, identify, and engage high-value targets. Company commander coordinates through the F2T2EA cycle, synchronizing ISR assets with company fires and platoon maneuver to create tactical effects across multiple platoon areas within the 12-24 hour planning horizon.</p>
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 16px;">
                    <div style="background: rgba(96, 165, 250, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(96, 165, 250, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 12px; line-height: 1.7; text-align: left;">
                            ...
                            <ul style="margin: 0; padding-left: 16px;">
                                <li style="margin-bottom: 4px;">Tactical depth (1-5 km)</li>
                                <li style="margin-bottom: 4px;">Multiple platoon operations</li>
                                <li style="margin-bottom: 4px;">Battalion ISR integration</li>
                                <li style="margin-bottom: 4px;">12-24 hour timeline</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div style="background: rgba(245, 158, 11, 0.1); padding: 18px; border-radius: 8px; border: 1px solid rgba(245, 158, 11, 0.3);">
                        ...
                        <div style="color: #e5e7eb; font-size: 12px; line-height: 1.7; text-align: left;">
                            ...
                            <ul style="margin: 0; padding-left: 16px;">
                                ...
                                <li style="margin-bottom: 4px;">Battalion ISR support</li>
            ...
            <div style="background: linear-gradient(135deg, #1f2937 0%, #111827 100%); border: 1px solid #374151; border-radius: 12px; padding: 24px; margin-bottom: 24px; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.3);">
                <h3 style="color: #f8fafc; font-size: 18px; font-weight: 600; margin: 0 0 16px 0; display: flex; align-items: center;">
                    ...
                    Company Reconnaissance and Security Operations: Doctrinal Summary
                </h3>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 16px;">
                    <div style="background: rgba(168, 85, 247, 0.15); padding: 18px; border-radius: 8px; border: 1px solid rgba(168, 85, 247, 0.4);">
                        ...
                        <div style="color: #e5e7eb; font-size: 12px; line-height: 1.7; text-align: left;">
                            <ul style="margin: 0; padding-left: 16px;">
                                <li style="margin-bottom: 6px;"><strong>Integration:</strong> Synchronize battalion and platoon ISR</li>
                                <li style="margin-bottom: 6px;"><strong>Coordination:</strong> Integrate multiple platoon operations</li>
                                <li style="margin-bottom: 6px;"><strong>Prioritization:</strong> Focus on company PIR</li>
                    ...
                    <div style="background: rgba(168, 85, 247, 0.15); padding: 18px; border-radius: 8px; border: 1px solid rgba(168, 85, 247, 0.4);">
                        ...
                        <div style="color: #e5e7eb; font-size: 12px; line-height: 1.7; text-align: left;">
                            <ul style="margin: 0; padding-left: 16px;">
                                ...
                                <li style="margin-bottom: 6px;"><strong>Battalion Integration:</strong> Coordinate with battalion S2 early</li>
                                <li style="margin-bottom: 6px;"><strong>Platoon Coordination:</strong> Integrate platoon requirements</li>
                    ...
                    <div style="background: rgba(168, 85, 247, 0.15); padding: 18px; border-radius: 8px; border: 1px solid rgba(168, 85, 247, 0.4);">
                        ...
                        <div style="color: #e5e7eb; font-size: 12px; line-height: 1.7; text-align: left;">
                            <ul style="margin: 0; padding-left: 16px;">
                                <li style="margin-bottom: 6px;"><strong>Inadequate Coordination:</strong> Failing to integrate battalion and platoon ISR</li>
                ...
                <div style="background: rgba(168, 85, 247, 0.2); padding: 20px; border-radius: 10px; border: 1px solid rgba(168, 85, 247, 0.5); margin-top: 20px;">
                    ...
                    <p style="color: #e5e7eb; font-size: 14px; line-height: 1.8; margin: 0; text-align: center; font-style: italic;">
                        "Company-level reconnaissance and security operations provide the tactical intelligence foundation enabling platoon operations and supporting battalion tactical objectives. Success requires seamless integration of battalion ISR support with platoon reconnaissance operations, synchronized through comprehensive planning, continuous coordination, and rapid intelligence dissemination across multiple platoon areas of operations within the 12-24 hour planning horizon."
                    </p>
