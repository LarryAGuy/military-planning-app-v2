 ...
 * Comprehensive implementation of fire and movement frameworks and tactical procedures
 * Contains detailed analysis, practical examples, and echelon-specific applications
 */

export const fireAndMovementContent = {
    title: 'Tactics: Fire & Movement',
    description: 'Combined arms fire support and tactical movement execution frameworks',
    getContent(){
        return `
            ...
            <div style="background-color: #1f2937; border: 1px solid #374151; border-radius: 8px; padding: 16px; margin-bottom: 16px;">
                <div style="display: flex; align-items: center; justify-content: space-between;">
                    <div style="flex: 1; padding-right: 16px;">
                        ...
                        <p style="font-size: 14px; color: #9ca3af;">Combined arms fire support and tactical movement execution frameworks</p>
                    </div>
                    <div style="background-color: #1e3a8a; border: 1px solid #1d4ed8; border-radius: 8px; padding: 8px; min-width: 192px; flex-shrink: 0;">
                        <div style="color: #dbeafe; font-size: 12px; line-height: 1.4;">
                            <div>FM 3-90 (Jul 2021), Chapter 4 — Fire Support</div>
                            <div>FM 3-09 (Apr 2020), Chapter 2 — Fire & Movement</div>
                            <div>JP 3-0 (Oct 2018), Chapter V — Fire Support</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="universal-fire-and-movement-nav" style="margin-bottom: 16px;">
                <!-- Universal button system will be injected here -->
            </div>

            <!-- Main Content Area for Module Loading -->
            <div id="fire-and-movement-content-area">
...
export default fireAndMovementContent;
