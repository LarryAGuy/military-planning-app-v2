/**
 * Tactics: Reconnaissance & Security
 * Comprehensive implementation of reconnaissance and security frameworks and tactical procedures
 * Contains detailed analysis, practical examples, and echelon-specific applications
 */

export const reconnaissanceAndSecurityContent = {
    title: 'Tactics: Reconnaissance & Security',
    description: 'Reconnaissance operations, security tactics, and information collection frameworks',
    getContent(){
        return `
                ...
                <div style="display: flex; align-items: center; justify-content: space-between;">
                    <div style="flex: 1; padding-right: 16px;">
                        <h1 style="font-size: 20px; font-weight: bold; color: white; margin-bottom: 4px;">
                            <i class="fas fa-search" style="margin-right: 8px; color: #60a5fa;"></i>
                            Reconnaissance & Security
                        </h1>
                        <p style="font-size: 14px; color: #9ca3af;">Reconnaissance operations, security tactics, and information collection frameworks</p>
                    </div>
                    <div style="background-color: #1e3a8a; border: 1px solid #1d4ed8; border-radius: 8px; padding: 8px; min-width: 192px; flex-shrink: 0;">
                        <div style="color: #dbeafe; font-size: 12px; line-height: 1.4;">
                            <div>FM 3-55 (May 2013), Chapter 2 — Information Collection</div>
                            <div>FM 3-90 (Jul 2021), Chapter 11 — Reconnaissance</div>
                            <div>JP 2-0 (Oct 2013), Chapter 4 — Collection Operations</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="universal-reconnaissance-and-security-nav" style="margin-bottom: 16px;">
                <!-- Universal button system will be injected here -->
            </div>

            <!-- Main Content Area for Module Loading -->
            <div id="reconnaissance-and-security-content-area">
...
export default reconnaissanceAndSecurityContent;
